...
import { k as Subscribable, s as shallowEqualObjects, l as hashKey, m as getDefaultState, n as notifyManager, e as useQueryClient, r as reactExports, o as noop$1, p as shouldThrowError, q as useRouterState, j as jsxRuntimeExports, t as shimExports, c as cn, v as reactDomExports, w as ReactDOM, a as useNavigate, x as useStopwatch, b as useSearch } from "./index-D_yjRFGt.js";
import { e as useLayoutEffect2, P as Primitive$1, c as composeEventHandlers, n as dispatchDiscreteCustomEvent, d as createContextScope$1, a as useId, u as useControllableState, b as Presence, m as createSlottable, X, i as Check, o as createSlot, p as createContext2, g as useDirection, f as createCollection, C as ChevronDown, l as Calendar, k as Clock, R as Receipt, F as FileText, j as ChevronLeft, h as ChevronRight, U as Users, G as Globe } from "./x-BHvIGru9.js";
import { P as Primitive, L as Label, I as Input, u as ue } from "./index-SoMYIp0N.js";
import { B as Button } from "./button-BXNzWYpr.js";
import { u as useComposedRefs } from "./index-HGa3Ynxo.js";
import { u as useActor, c as createActor, b as useQuery, d as useAuth } from "./useAuthStore-RPelH0kd.js";
...
const CalendarOff = createLucideIcon("calendar-off", __iconNode$i);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const LockKeyhole = createLucideIcon("lock-keyhole", __iconNode$b);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const logoImg = "/assets/ireport_logo.png";
function ChatWidget({ onClose }) {
  const { actor } = useActor(createActor);
  const [messages, setMessages] = reactExports.useState([
    {
      role: "assistant",
      content: "Hallo! Ich bin dein iReport Support-Assistent. Wie kann ich dir helfen?"
    }
  ]);
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold text-sm", children: "iReport Assistent" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              messages.map((msg, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: `max-w-[80%] rounded-xl px-3 py-2 text-sm leading-relaxed ${msg.role === "user" ? "text-white" : "bg-gray-100 text-gray-800"}`,
                      style: msg.role === "user" ? { background: "#006066" } : void 0,
              ...
              isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-100 rounded-xl px-3 py-2 flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin text-gray-500" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-500", children: "Tippe..." })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: messagesEndRef })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-gray-200 px-3 py-3 flex items-center gap-2 bg-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
...
function NotificationBadge({
  ...
  const label = count2 > 99 ? "99+" : String(count2);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "span",
    {
...
var Erfassungsart = /* @__PURE__ */ ((Erfassungsart2) => {
  Erfassungsart2["zeitBlock"] = "zeitBlock";
  Erfassungsart2["dauer"] = "dauer";
  return Erfassungsart2;
})(Erfassungsart || {});
var NotificationFormat = /* @__PURE__ */ ((NotificationFormat2) => {
  NotificationFormat2["html"] = "html";
  NotificationFormat2["markdown"] = "markdown";
  return NotificationFormat2;
})(NotificationFormat || {});
var NotificationPriority = /* @__PURE__ */ ((NotificationPriority2) => {
  NotificationPriority2["normal"] = "normal";
  NotificationPriority2["important"] = "important";
  NotificationPriority2["critical"] = "critical";
  return NotificationPriority2;
})(NotificationPriority || {});
var NotificationStatus = /* @__PURE__ */ ((NotificationStatus2) => {
  NotificationStatus2["sent"] = "sent";
  NotificationStatus2["draft"] = "draft";
  NotificationStatus2["archived"] = "archived";
  return NotificationStatus2;
})(NotificationStatus || {});
var NotificationTargetType = /* @__PURE__ */ ((NotificationTargetType2) => {
  NotificationTargetType2["mixed"] = "mixed";
  NotificationTargetType2["role"] = "role";
  NotificationTargetType2["user"] = "user";
  NotificationTargetType2["tenant"] = "tenant";
  return NotificationTargetType2;
})(NotificationTargetType || {});
var Variant_gutschrift_reduktion = /* @__PURE__ */ ((Variant_gutschrift_reduktion2) => {
  Variant_gutschrift_reduktion2["gutschrift"] = "gutschrift";
  Variant_gutschrift_reduktion2["reduktion"] = "reduktion";
  return Variant_gutschrift_reduktion2;
...
function NotificationItem({
  ...
  const rowClass = [
    ...
    n.priority === NotificationPriority.critical ? "border-l-2 border-destructive" : "",
    n.priority === NotificationPriority.important && isRead === false ? "border-l-2 border-amber-500" : "",
    "hover:bg-muted/40"
  ].filter(Boolean).join(" ");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          ...
          !compact && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: n.senderDisplayName }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground mt-0.5", children: formatNanos(n.createdAt) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 py-2 border-b border-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: "Benachrichtigungen" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-80 overflow-y-auto divide-y divide-border", children: notifications.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-6", children: "Keine Benachrichtigungen" }) : notifications.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          NotificationItem,
          {
            notification: n,
            compact: true,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            children: "Alle Benachrichtigungen anzeigen"
          }
        ) })
      ]
    }
...
function NotificationBell() {
  ...
  const { data: unreadCount = 0n } = useQuery({
    ...
    queryFn: async () => {
      ...
      return await anyActor.getUnreadCount();
    },
    enabled: !!actor && !isFetching,
  ...
  const count2 = Number(unreadCount);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", "data-ocid": "notification.bell", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        "aria-label": `Benachrichtigungen${count2 > 0 ? ` (${count2} ungelesen)` : ""}`,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationBadge, { count: count2 })
        ]
      }
    ),
    open && /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationDropdown, { onClose: () => setOpen(false) })
  ] });
}
...
function useCompanyTimezone() {
  ...
  return (data == null ? void 0 : data.timezone) || DEFAULT_TIMEZONE;
}
function toDateStringInTz(date, timezone) {
  try {
...
function formatDateInTz(date, timezone, options) {
  try {
...
function isValidHHMM(value) {
  return /^\d{1,2}:\d{2}$/.test(value) && Number.parseInt(value.split(":")[1], 10) < 60;
}
...
const defaultForm = (date) => ({
  ...
  description: "",
  billable: false
  // will be auto-set based on stundensatz when project+serviceType are selected
});
...
function subtractMinutes(timeHHMM, minutes) {
...
function TimeEntryDialog({
  ...
  const { actor, isFetching } = useActor(createActor);
  const todayStr = toDateStringInTz(/* @__PURE__ */ new Date(), "Europe/Zurich");
  const [form, setForm] = reactExports.useState(defaultForm(todayStr));
  ...
  const initialValuesRef = reactExports.useRef(initialValues);
  ...
  reactExports.useEffect(() => {
    ...
    if (editEntry) {
      ...
      const base = defaultForm((iv == null ? void 0 : iv.date) ?? todayStr);
      const merged = { ...base, ...iv };
      if ((iv == null ? void 0 : iv.hours) && !iv.von) {
  ...
  const erfassungsart = (selectedProject == null ? void 0 : selectedProject.erfassungsart) ?? Erfassungsart.dauer;
  ...
  const currentStundensatz = reactExports.useMemo(() => {
    ...
    const myAssignment = members.find(
      (m) => String(m.employeeId) === String(employeeId) && String(m.serviceTypeId) === form.serviceTypeId
    );
  ...
  const prevServiceTypeIdRef = reactExports.useRef("");
  const prevProjectIdRef = reactExports.useRef("");
  reactExports.useEffect(() => {
  ...
  const zeitBlockDuration = reactExports.useMemo(() => {
  ...
  function handleProjectChange(projectId) {
    ...
    const newArt = (proj == null ? void 0 : proj.erfassungsart) ?? Erfassungsart.dauer;
    setForm((f) => ({
      ...f,
      projectId,
      serviceTypeId: "",
  ...
  function validate() {
    ...
    if (isZeitBlock) {
      ...
      if (form.von && form.bis && hhmmToMinutes(form.bis) <= hhmmToMinutes(form.von)) {
  ...
  async function handleSave() {
    ...
    try {
      if (editEntry) {
        ...
        ue.success("Zeiteintrag aktualisiert");
      } else {
        const res = await toAny(actor).createTimeEntry(payload);
        if (res.__kind__ === "err") throw new Error(res.err);
        ue.success("Zeiteintrag gespeichert");
      }
      onOpenChange(false);
  ...
  const dialogTitle = title ?? (editEntry ? "Zeiteintrag bearbeiten" : "Zeit erfassen");
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "ted-date", children: [
              "Datum ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "ted-project", children: [
              "Projekt ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
            ] }),
            isLoadingData ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 bg-muted animate-pulse rounded-md" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: visibleProjects.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: String(p.id), children: [
                    "[",
                    p.code,
                    "] ",
                    p.name
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "ted-service", children: [
              "Leistungsart ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                ...
                onValueChange: (v) => setForm((f) => ({ ...f, serviceTypeId: v })),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SelectTrigger,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        SelectValue,
                        {
                          placeholder: form.projectId ? "Leistungsart wählen…" : "Erst Projekt wählen"
                        }
                      )
                    }
                  ),
          ...
          isZeitBlock ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md bg-muted/50 px-3 py-1.5 text-xs text-muted-foreground border border-border", children: [
              "Zeiterfassung:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: "Zeit-Block (von / bis)" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "ted-von", children: [
                  "Von (hh:mm) ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                errors.von && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.von })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "ted-bis", children: [
                  "Bis (hh:mm) ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                errors.bis && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.bis })
              ] })
            ] }),
            zeitBlockDuration && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
              "Dauer:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground tabular-nums", children: zeitBlockDuration })
            ] })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "ted-hours", children: [
              "Dauer (hh:mm) ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            errors.hours && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.hours })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "ted-desc", children: [
              "Beschreibung",
              " ",
          ...
          showVerrechenbar && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 pt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Checkbox,
              {
                id: "ted-billable",
                checked: form.billable,
                onCheckedChange: (checked) => setForm((f) => ({ ...f, billable: checked === true })),
                "data-ocid": "entry-billable-checkbox"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "ted-billable", className: "cursor-pointer", children: "Verrechenbar" })
          ] })
        ] }),
...
function StopwatchWidget() {
  ...
  function handleCopyTime() {
    ...
    navigator.clipboard.writeText(hhmm).then(
      () => ue.success(`Zeit ${hhmm} in Zwischenablage kopiert`),
      () => ue.info(`Erfasste Zeit: ${hhmm}`)
    );
  }
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `text-sm font-mono tabular-nums font-semibold min-w-[68px] text-center select-none ${isRunning ? "text-emerald-600 dark:text-emerald-400" : hasTime ? "text-foreground" : "text-muted-foreground"}`,
              "data-ocid": "stopwatch-display",
              children: displayTime
            }
          ),
          !isRunning ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Timer, { className: "w-3.5 h-3.5" })
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "bottom", children: "Stoppuhr starten" })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "bottom", children: "Stoppen & Zeit erfassen" })
          ] }),
          hasTime && !isRunning && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold leading-none", children: "+Zeit" })
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "bottom", children: "Zeit erfassen" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold leading-none", children: "hh:mm" })
                }
              ) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "bottom", children: "Zurücksetzen" })
            ] })
          ] })
        ]
      }
...
const topNavItems = [
  ...
  { icon: ChartNoAxesColumn, label: "Auswertungen", path: "/auswertungen" },
  {
    icon: FileText,
    label: "Fakturierung",
    path: "/fakturierung",
...
function Layout({ children }) {
  ...
  const subscriptionPlanName = ((_a2 = subscriptionPlanQuery.data) == null ? void 0 : _a2.name) ?? null;
  ...
  const { data: planFeatures = [] } = useQuery({
    ...
    queryFn: async () => await planActor.getMyPlanFeatures(),
    enabled: !!planActor && !planFetching && planRole !== "platformAdmin" && !planIsAdmin,
    staleTime: 3e5
  });
  ...
  const featurePaths = new Set(
    planFeatures.map((k) => FEATURE_PATH_MAP[k]).filter(Boolean)
  );
  const [sidebarExpanded, setSidebarExpanded] = reactExports.useState(() => {
    try {
  ...
  const [supportTooltip, setSupportTooltip] = reactExports.useState(false);
  const [isChatOpen, setIsChatOpen] = reactExports.useState(false);
  const [chatAvailable, setChatAvailable] = reactExports.useState(false);
  const navigate = useNavigate();
  ...
  reactExports.useEffect(() => {
    ...
    chatActor.getOpenAIEnabled().then((res) => {
      console.log("[ChatButton] getOpenAIEnabled result:", res);
      setChatAvailable(!!(res == null ? void 0 : res.isConfigured));
    }).catch((err) => {
  ...
  const featureFilteredNav = planFeatures.length > 0 && userRole !== "platformAdmin" && !isPlatformAdmin ? visibleNav.filter((item) => {
    const itemPath = item.path || "";
    const isMappedPath = Object.values(FEATURE_PATH_MAP).includes(itemPath);
    return !isMappedPath || featurePaths.has(itemPath);
  }) : visibleNav;
  const isAdminOrManager = userRole === "admin" || userRole === "manager";
  const isStammdatenActive = location.pathname === "/stammdaten" || location.pathname.startsWith("/stammdaten");
  ...
  const handleStammdatenSubNav = (tab) => {
    navigate({ to: "/stammdaten", search: { tab } });
  };
  const navButtonClass = (isActive, collapsed) => `w-full flex items-center gap-3 px-3 py-2.5 rounded-md transition-colors text-sm font-medium ${isActive ? "bg-primary text-primary-foreground" : "text-foreground hover:bg-muted hover:text-foreground"} ${collapsed ? "justify-center" : "justify-start"}`;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { delayDuration: 300, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen overflow-hidden bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "aside",
      {
        "data-ocid": "sidebar",
        className: `flex flex-col bg-card border-r border-border transition-all duration-300 ease-in-out ${sidebarExpanded ? "w-60" : "w-[60px]"} flex-shrink-0 relative z-30`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-[60px] px-3 border-b border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                "aria-label": "iReport",
                children: sidebarExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: logoImg,
                    alt: "iReport",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                "aria-label": sidebarExpanded ? "Sidebar einklappen" : "Sidebar ausklappen",
                children: sidebarExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-4 h-4" })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex-1 overflow-y-auto py-2 space-y-0.5 px-1", children: [
              ...
              const navButton = /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    sidebarExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: item.label })
                  ]
                },
                item.path
              );
              return sidebarExpanded ? navButton : /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
            ...
            isAdminOrManager && (sidebarExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Database, { className: "w-4 h-4 flex-shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate flex-1 text-left", children: "Stammdaten" }),
                    stammdatenOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-3.5 h-3.5 flex-shrink-0 opacity-70" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3.5 h-3.5 flex-shrink-0 opacity-70" })
                  ]
                }
              ),
              stammdatenOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-3 mt-0.5 space-y-0.5 border-l-2 border-primary/20 pl-2", children: stammdatenSubItems.map((sub) => {
                const isSubActive = isStammdatenActive && activeTab === sub.tab;
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    className: `w-full flex items-center gap-2 px-2 py-2 rounded-md transition-colors text-xs font-medium ${isSubActive ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:bg-muted hover:text-foreground"}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SubIcon, { className: "w-3.5 h-3.5 flex-shrink-0" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: sub.label })
                    ]
                  },
                  sub.tab
                );
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Database, { className: "w-4 h-4 flex-shrink-0" })
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "right", children: "Stammdaten" })
            ] })),
            sidebarExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "w-4 h-4 flex-shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: "Einstellungen" })
                ]
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "w-4 h-4 flex-shrink-0" })
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "right", children: "Einstellungen" })
            ] }),
            isPlatformAdmin && (sidebarExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `w-full flex items-center gap-3 px-3 py-2.5 rounded-md transition-colors text-sm font-medium justify-start ${location.pathname === "/platform-admin" ? "bg-primary text-primary-foreground" : "text-primary hover:bg-primary/10 hover:text-primary"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-4 h-4 flex-shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: "Platform-Admin" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `w-full flex items-center gap-3 px-3 py-2.5 rounded-md transition-colors text-sm font-medium justify-start ${location.pathname === "/kosten-dashboard" ? "bg-primary text-primary-foreground" : "text-primary hover:bg-primary/10 hover:text-primary"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "w-4 h-4 flex-shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: "Kosten-Dashboard" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  onClick: () => navigate({ to: "/platform-admin/benachrichtigungen" }),
                  className: `w-full flex items-center gap-3 px-3 py-2.5 rounded-md transition-colors text-sm font-medium justify-start ${location.pathname === "/platform-admin/benachrichtigungen" ? "bg-primary text-primary-foreground" : "text-primary hover:bg-primary/10 hover:text-primary"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "w-4 h-4 flex-shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: "Nachrichtenverwaltung" })
                  ]
                }
              )
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    "data-ocid": "nav-platform-admin",
                    onClick: () => navigate({ to: "/platform-admin" }),
                    className: `w-full flex items-center justify-center gap-3 px-3 py-2.5 rounded-md transition-colors text-sm font-medium ${location.pathname === "/platform-admin" ? "bg-primary text-primary-foreground" : "text-primary hover:bg-primary/10"}`,
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-4 h-4 flex-shrink-0" })
                  }
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "right", children: "Platform-Admin" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    "data-ocid": "nav-kosten-dashboard",
                    onClick: () => navigate({ to: "/kosten-dashboard" }),
                    className: `w-full flex items-center justify-center gap-3 px-3 py-2.5 rounded-md transition-colors text-sm font-medium ${location.pathname === "/kosten-dashboard" ? "bg-primary text-primary-foreground" : "text-primary hover:bg-primary/10"}`,
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "w-4 h-4 flex-shrink-0" })
                  }
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "right", children: "Kosten-Dashboard" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    "data-ocid": "nav-notification-admin",
                    onClick: () => navigate({ to: "/platform-admin/benachrichtigungen" }),
                    className: `w-full flex items-center justify-center gap-3 px-3 py-2.5 rounded-md transition-colors text-sm font-medium ${location.pathname === "/platform-admin/benachrichtigungen" ? "bg-primary text-primary-foreground" : "text-primary hover:bg-primary/10"}`,
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "w-4 h-4 flex-shrink-0" })
                  }
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "right", children: "Nachrichtenverwaltung" })
              ] })
            ] }))
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border px-1 py-2", children: [
            ...
            sidebarExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Abmelden" })
                ]
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(LogOut, { className: "w-4 h-4 flex-shrink-0" })
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "right", children: "Abmelden" })
            ] })
          ] })
        ]
      }
        ...
        "header",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
              companyLogoUrl && !isPlatformAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: companyLogoUrl,
              ...
              companyName && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-sm text-foreground truncate max-w-[180px]", children: companyName }),
              subscriptionPlanName && !isPlatformAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  "data-ocid": "header.subscription_plan_badge",
                  className: "text-[10px] px-2 py-0.5 rounded-full font-medium flex-shrink-0",
                  style: { backgroundColor: "#006066", color: "#ffffff" },
                  children: subscriptionPlanName
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(StopwatchWidget, {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationBell, {}),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-8 h-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-primary text-primary-foreground text-xs font-semibold", children: getInitials(employeeName) }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex flex-col leading-tight", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground truncate max-w-[150px]", children: employeeName ?? "Benutzer" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: userRole === "admin" ? "Administrator" : userRole === "manager" ? "Manager" : "Mitarbeiter" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { children: "Abmelden" })
              ] })
            ] })
          ]
        }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-6 right-6 z-50 no-print", children: [
      isChatOpen && chatAvailable && /* @__PURE__ */ jsxRuntimeExports.jsx(ChatWidget, { onClose: () => setIsChatOpen(false) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Tooltip,
        {
          open: chatAvailable ? void 0 : supportTooltip,
          onOpenChange: chatAvailable ? void 0 : setSupportTooltip,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                onClick: () => chatAvailable ? setIsChatOpen((v) => !v) : setSupportTooltip(!supportTooltip),
                disabled: false,
            ...
            !chatAvailable && /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { side: "left", className: "text-sm", children: "Chat wird bald verfügbar sein" })
          ]
        }
      )
    ] })
...
export {
  ...
  useSize as K,
  Layout as L,
  NotificationPriority as M,
  NotificationFormat as N,
  Overlay as O,
  Portal$1 as P,
  NotificationItem as Q,
  RefreshCw as R,
  Select as S,
  TimeEntryDialog as T,
  useCallbackRef$1 as U,
  Variant_gutschrift_reduktion as V,
  WarningProvider as W,
  NotificationStatus as X,
  NotificationTargetType as Y,
  SelectTrigger as a,
  SelectValue as b,
  SelectContent as c,
  SelectItem as d,
  ...
  hhmmToMinutes as l,
  minutesToHHMM as m,
  normalizeTimeInput as n,
  isValidHHMM as o,
  Timer as p,
  useMutation as q,
  Send as r,
  Root as s,
  toDateStringInTz as t,
  useCompanyTimezone as u,
  Content as v,
  Title as w,
  Description as x,
  Close as y,
