import { r as reactExports, j as jsxRuntimeExports, S as Skeleton } from "./index-Blf-A8DR.js";
...
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, f as formatHours, m as minutesToHHMM$1, L as Layout, C as ChartNoAxesColumn } from "./Layout-ClH0znk9.js";
import { b as useAuth, u as useActor, c as createActor, d as useQuery, A as AuditEntityType, e as AuditOperation } from "./useAuthStore-Cbv7GIMf.js";
...
import { F as FileText, C as ChevronDown, h as ChevronRight } from "./users-DUrIKgtR.js";
import { C as ClipboardList } from "./clipboard-list-e1sYZFcd.js";
import { S as Shield } from "./shield-CIXAU-Kp.js";
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        TableCell,
                        {
                          ...
                          children: (() => {
                            ...
                            if (fc && fc.length > 0) {
                              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 text-xs", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-muted-foreground uppercase tracking-wide text-[10px]", children: "Geänderte Felder" }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: fc.map((change) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                                  "div",
                                  {
                                    className: "flex items-start gap-1.5 p-1.5 rounded bg-background border border-border/60",
                                    children: [
                                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium text-foreground min-w-[100px] flex-shrink-0", children: [
                                        change.fieldName,
                                        ":"
                                      ] }),
                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive line-through break-words min-w-0", children: change.before || "—" }),
                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground flex-shrink-0", children: "\\u2192" }),
                                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-700 break-words min-w-0", children: change.after || "—" })
                                    ]
                                  },
                                  `${change.fieldName}-${change.before}`
                                )) })
                              ] });
                            }
