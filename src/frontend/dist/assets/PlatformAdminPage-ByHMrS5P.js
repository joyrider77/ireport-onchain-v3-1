import { j as jsxRuntimeExports, r as reactExports, S as Skeleton, e as useQueryClient, R as React } from "./index-D_yjRFGt.js";
...
import { q as useMutation, L as Layout, I as ShieldCheck, B as Building2, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, C as ChartNoAxesColumn, R as RefreshCw, D as Dialog, g as DialogContent, h as DialogHeader, i as DialogTitle, k as DialogFooter } from "./Layout-BOoVnXJI.js";
...
import { u as useActor, b as useQuery, c as createActor, d as useAuth } from "./useAuthStore-RPelH0kd.js";
...
import { R as ReceiptText, P as PaymentStatusBadge } from "./PaymentStatusBadge-B1s_1XCz.js";
import { i as isUnlimited } from "./planUtils-CmuewgAl.js";
import { U as Users, C as ChevronDown, h as ChevronRight, X, i as Check } from "./x-BHvIGru9.js";
...
import { E as EyeOff } from "./eye-off-Cqhd6RGj.js";
...
const FileSpreadsheet = createLucideIcon("file-spreadsheet", __iconNode$4);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function SubscriptionPlanModal({
  ...
  const [newAdditionalFeature, setNewAdditionalFeature] = reactExports.useState("");
  reactExports.useEffect(() => {
    if (open) {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 pt-2 border-t border-border/50", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "block text-sm font-medium", children: "Zusätzliche Funktionen" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Manuell erfasste Funktionen (z.B. Premium-Support, Onboarding-Service)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      ...
                      onKeyDown: (e) => {
                        if (e.key === "Enter") {
                          ...
                          if (trimmed && !(form.additionalFeatures ?? []).includes(trimmed)) {
                            setForm((f) => ({
                              ...f,
                              additionalFeatures: [
                ...
                (form.additionalFeatures ?? []).length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-1 mt-1", children: (form.additionalFeatures ?? []).map((feat, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          onClick: () => setForm((f) => ({
                            ...f,
                            additionalFeatures: (f.additionalFeatures ?? []).filter((x) => x !== feat)
                          })),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-2 border-t border-border/50", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium", children: "Empfohlen" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground mt-0.5", children: "Als empfohlener Plan auf der Startseite hervorheben" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Switch,
                  {
                    ...
                    onCheckedChange: (checked) => setForm((f) => ({ ...f, isRecommended: checked }))
                  }
                )
              ] })
            ] }),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            (() => {
              ...
              const additionals = (plan.additionalFeatures ?? []).filter(
                (a) => !checkedLabelsLower.includes(a.toLowerCase().trim())
              );
              const allTags = [
                ...new Set(
                  [...checkedLabels, ...additionals].map((t) => t.trim()).filter(Boolean)
                )
              ];
              return allTags.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1", children: [
                plan.isRecommended && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center px-1.5 py-0.5 bg-green-500/15 text-green-700 text-[10px] rounded-full border border-green-500/30 font-medium", children: "★ Empfohlen" }),
              ...
              ] }) : plan.isRecommended ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center px-1.5 py-0.5 bg-green-500/15 text-green-700 text-[10px] rounded-full border border-green-500/30 font-medium", children: "★ Empfohlen" }) }) : null;
            })()
          ] }),
...
function WissensbasisSection() {
  ...
  const [formCategory, setFormCategory] = reactExports.useState("faq");
  const [formTitle, setFormTitle] = reactExports.useState("");
  const [formContent, setFormContent] = reactExports.useState("");
  const [formLanguage, setFormLanguage] = reactExports.useState("de");
  const [formRole, setFormRole] = reactExports.useState("all");
  ...
  const addMutation = useMutation({
    mutationFn: async (data) => {
      ...
      const result = await toAny(actor).addKnowledgeEntry(data);
      if ("err" in result) throw new Error(result.err);
      return result.ok;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["knowledgeEntriesAdmin"] });
      ue.success("Eintrag hinzugefügt.");
      closeModal();
    },
  ...
  const updateMutation = useMutation({
    mutationFn: async ({
      ...
      if (!actor) throw new Error("Kein Actor");
      const result = await toAny(actor).updateKnowledgeEntry(id, data);
      if ("err" in result) throw new Error(result.err);
      return result.ok;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["knowledgeEntriesAdmin"] });
      ue.success("Eintrag aktualisiert.");
      closeModal();
    },
    onError: (e) => ue.error(e.message)
  });
  const deleteMutation = useMutation({
    mutationFn: async (id) => {
      if (!actor) throw new Error("Kein Actor");
      const result = await toAny(actor).deleteKnowledgeEntry(id);
      if ("err" in result) throw new Error(result.err);
      return result.ok;
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["knowledgeEntriesAdmin"] });
      ue.success("Eintrag gelöscht.");
  ...
  function handleSave() {
    ...
    if (!data.title || !data.content) {
      ue.error("Titel und Inhalt sind erforderlich.");
      return;
    }
    if (editingEntry) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "mt-4", "data-ocid": "platform-admin.wissensbasis_card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Inhalte für den KI-Assistenten" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Kategorie:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "all", children: "Alle" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "faq", children: "FAQ" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "feature", children: "Funktion" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "guide", children: "Anleitung" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "help", children: "Hilfe" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "trust", children: "Vertrauen" })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Rolle:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                value: filterRole,
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "mitarbeiter", children: "Mitarbeiter" })
                ]
              }
            )
          ] }),
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-full" }, i)) }) : filteredEntries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-border rounded-md overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-muted/40 border-b border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-3 py-2 font-medium text-muted-foreground", children: "Kategorie" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-3 py-2 font-medium text-muted-foreground", children: "Titel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-3 py-2 font-medium text-muted-foreground", children: "Rolle" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-3 py-2 font-medium text-muted-foreground", children: "Sprache" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-3 py-2 font-medium text-muted-foreground", children: "Aktiv" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-3 py-2 font-medium text-muted-foreground", children: "Aktionen" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: filteredEntries.map((entry, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "tr",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `inline-flex items-center px-1.5 py-0.5 rounded border text-xs font-medium ${CATEGORY_BADGE_COLORS[entry.category] ?? "bg-muted text-foreground border-border"}`,
                    children: CATEGORY_MAP[entry.category] ?? entry.category
                  }
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2 max-w-[200px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center px-1.5 py-0.5 rounded border text-xs bg-muted text-muted-foreground border-border", children: ROLE_MAP[entry.role] ?? entry.role }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center px-1.5 py-0.5 rounded border text-xs bg-muted text-muted-foreground border-border", children: LANG_MAP[entry.language] ?? entry.language.toUpperCase() }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2", children: entry.isActive ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-3.5 h-3.5 text-green-600" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-3.5 h-3.5 text-muted-foreground" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-end gap-1", children: deleteConfirmId === entry.id ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-red-600 mr-1", children: "Löschen?" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showModal, onOpenChange: (open) => !open && closeModal(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      DialogContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: editingEntry ? "Eintrag bearbeiten" : "Neuer Eintrag" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 py-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium", children: "Kategorie" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: formCategory, onValueChange: setFormCategory, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "faq", children: "FAQ" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "feature", children: "Funktion" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "guide", children: "Anleitung" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "help", children: "Hilfe" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "trust", children: "Vertrauen" })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium", children: "Titel" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  value: formTitle,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium", children: "Inhalt" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Textarea,
                {
                  value: formContent,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium", children: "Sprache" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: formLanguage, onValueChange: setFormLanguage, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SelectTrigger,
                    {
                      className: "h-8 text-xs",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "de", children: "Deutsch (DE)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "en", children: "English (EN)" })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium", children: "Rolle" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: formRole, onValueChange: setFormRole, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SelectTrigger,
                    {
                      className: "h-8 text-xs",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "admin", children: "Admin" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "manager", children: "Manager" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "mitarbeiter", children: "Mitarbeiter" })
                  ] })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "form-isActive", className: "text-xs cursor-pointer", children: "Aktiv" })
            ] })
          ] }),
...
function KIConfigSection() {
  ...
  const [isSavingOpenAI, setIsSavingOpenAI] = reactExports.useState(false);
  const [isTestingOpenAI, setIsTestingOpenAI] = reactExports.useState(false);
  const [openAITestResult, setOpenAITestResult] = reactExports.useState(null);
  const [openAIError, setOpenAIError] = reactExports.useState(null);
  const { data: openAIStatus, refetch: refetchOpenAIStatus } = useQuery({
    ...
    queryFn: async () => {
      ...
      try {
        return await toAny(actor).getOpenAIConfigStatus();
      } catch {
  ...
  async function handleSaveOpenAI() {
    ...
    setOpenAIError(null);
    try {
      const result = await toAny(actor).setOpenAIConfig(openAIKey.trim());
      if (result.__kind__ === "ok") {
        ue.success("OpenAI API Key gespeichert.");
        setOpenAIKey("");
        refetchOpenAIStatus();
      } else {
        ue.error(result.err ?? "Fehler beim Speichern.");
      }
    } catch (e) {
      ue.error(e instanceof Error ? e.message : "Fehler beim Speichern.");
    } finally {
  ...
  async function handleTestOpenAI() {
    ...
    setOpenAIError(null);
    try {
      const result = await toAny(actor).testOpenAIConnection();
      if (result.__kind__ === "ok") {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { "data-ocid": "platform-admin.ki_config_card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base font-semibold flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-4 h-4 text-primary" }),
        "KI-Konfiguration"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "OpenAI API Key für den Chat-Assistenten hinterlegen." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Status:" }),
        (openAIStatus == null ? void 0 : openAIStatus.isConfigured) ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 bg-green-500/10 text-green-700 text-xs rounded-full border border-green-500/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-3 h-3" }),
          "Konfiguriert"
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 bg-yellow-500/10 text-yellow-700 text-xs rounded-full border border-yellow-500/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-3 h-3" }),
          "Nicht konfiguriert"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-medium", children: "OpenAI API Key" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: isSavingOpenAI ? "Speichern..." : "Speichern"
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            variant: "outline",
            size: "sm",
            disabled: isTestingOpenAI || !(openAIStatus == null ? void 0 : openAIStatus.isConfigured),
            onClick: handleTestOpenAI,
            "data-ocid": "platform-admin.ki_test_button",
            children: isTestingOpenAI ? "Teste..." : "Verbindung testen"
          }
        ),
        openAITestResult && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-green-700 flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-3 h-3" }),
          openAITestResult
        ] }),
        openAIError && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-red-600 flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "w-3 h-3" }),
          openAIError
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(WissensbasisSection, {})
    ] })
  ] });
}
...
function PlatformAdminPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-5xl mx-auto space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(KIConfigSection, {}),
