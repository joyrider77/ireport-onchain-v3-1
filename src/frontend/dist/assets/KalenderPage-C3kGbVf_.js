import { r as reactExports, j as jsxRuntimeExports, a as useNavigate, e as useQueryClient, S as Skeleton } from "./index-D_yjRFGt.js";
...
import { u as useCompanyTimezone, t as toDateStringInTz, L as Layout, T as TimeEntryDialog, f as formatHours, m as minutesToHHMM, D as Dialog, g as DialogContent, h as DialogHeader, i as DialogTitle, j as Checkbox, n as normalizeTimeInput, k as DialogFooter, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, l as hhmmToMinutes, o as isValidHHMM } from "./Layout-BOoVnXJI.js";
...
import { g as getActiveEmploymentForDate, a as getEmploymentMinutesForDate, b as getMostRecentEmploymentBefore, c as countVacationDaysProportional } from "./employmentUtils-C-5ZbofZ.js";
import { g as getISOWeekNumber } from "./timeOverviewAggregation-BCmGA-wR.js";
import { j as ChevronLeft, h as ChevronRight, k as Clock, R as Receipt, X } from "./x-BHvIGru9.js";
...
import { C as CalendarDays } from "./calendar-days-DCWMIg0i.js";
import "./lock-BD6_Ipmh.js";
...
function isVacationType(absenceTypeId, types) {
  const t = types.find((x) => x.id === absenceTypeId);
  return (t == null ? void 0 : t.name.toLowerCase()) === "ferien";
}
function holidaysForDay(holidays, iso) {
...
function requiredPauseMinutes(workMinutes) {
...
function minutesToHHMMShort(minutes) {
...
function detectPausesForDay(timeEntries, absences, absenceTypes) {
  const hasFullDayNonWork = absences.some((a) => {
    var _a;
    const typeName = ((_a = absenceTypes.find((t) => t.id === a.absenceTypeId)) == null ? void 0 : _a.name.toLowerCase()) ?? "";
    return a.ganztaetig && NON_WORK_ABSENCE_NAMES.some((n) => typeName.includes(n));
  });
...
function PauseIndicator({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      title: `Pause: ${minutesToHHMMShort(totalPauseMin)}${required > 0 ? ` (mind. ${minutesToHHMMShort(required)} erforderlich)` : ""}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `w-1.5 h-1.5 rounded-full shrink-0 ${dotColor}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[0.55rem] font-medium leading-none tabular-nums", children: [
          "⏸ ",
...
function EntryTooltip({
  ...
  const left = coords.x + OFFSET + TOOLTIP_W > vw2 ? Math.max(4, coords.x - TOOLTIP_W - OFFSET) : coords.x + OFFSET;
  const top = coords.y + OFFSET + TOOLTIP_H + 20 > vh2 ? Math.max(4, coords.y - TOOLTIP_H - OFFSET) : coords.y + OFFSET;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "relative",
...
function EntryRow({
  ...
  const row = /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(EntryTooltip, { content: tooltip, children: row });
}
function DayCell({
  day,
  absenceTypes,
  ...
  const absenceHours = (() => {
    ...
    for (const a of day.absences) {
      ...
      if (!isVacation && !isCompensated) continue;
      if (a.ganztaetig) {
        const activeEmp = getActiveEmploymentForDate(employments, iso) ?? getMostRecentEmploymentBefore(employments, iso);
        const sollMinutes = activeEmp ? getEmploymentMinutesForDate(activeEmp, iso) : 0;
  ...
  const hasVacation = day.absences.some(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      className: [
        ...
        noSollHours && day.isCurrentMonth && !day.isToday ? "opacity-40" : day.isWeekend && day.isCurrentMonth ? "opacity-60" : "",
        day.isToday ? "border-primary ring-1 ring-inset ring-primary/30" : "border-border hover:border-primary/40",
        "cursor-pointer hover:shadow-sm"
      ].join(" "),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-1.5 pt-1 pb-0.5 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: [
                "text-[0.72rem] font-semibold leading-none",
                day.isToday ? "text-primary-foreground bg-primary rounded-full w-5 h-5 flex items-center justify-center" : day.isCurrentMonth ? "text-foreground" : "text-muted-foreground"
              ].join(" "),
              children: day.date.getDate()
            }
          ),
          totalHours > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[0.6rem] font-semibold text-blue-600 tabular-nums", children: formatHours(totalHours) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-px px-0.5 pb-1 overflow-hidden flex-1", children: [
          day.holidays.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            EntryRow,
            {
              variant: "holiday",
              label: h.name,
              tooltip: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: h.name }),
          ...
          day.timeEntries.map((te) => {
            ...
            const timeLabel = te.von && te.bis ? `${te.von}–${te.bis}` : formatHours(te.hours);
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              EntryRow,
              {
                ...
                tooltip: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: (proj == null ? void 0 : proj.name) ?? "–" }),
                  te.von && te.bis ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
                    "Zeit: ",
                    te.von,
                    " – ",
                    te.bis
                  ...
                  te.description && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground break-words line-clamp-3", children: [
                    "Beschreibung: ",
                    te.description
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
          ...
          day.expenses.map((ex) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            EntryRow,
            {
              variant: "expense",
              label: `${(ex.billableCHF + ex.reimbursementCHF).toFixed(0)} CHF`,
              tooltip: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: "Spesen" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
                  "Betrag: ",
                  (ex.billableCHF + ex.reimbursementCHF).toFixed(2),
                  " ",
                  "CHF"
                ] }),
                ex.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground break-words line-clamp-3", children: ex.description }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
                  "Status:",
                  " ",
                  ex.status === "approved" ? "Genehmigt" : ex.status === "rejected" ? "Abgelehnt" : "Ausstehend"
                ] })
              ] })
            },
            String(ex.id)
          )),
          hasVacation && day.absences.filter((a) => isVacationType(a.absenceTypeId, absenceTypes)).map((a) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            EntryRow,
            {
              variant: "vacation",
              label: "Ferien",
              tooltip: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: "Ferien" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
                  "Von: ",
                ...
                Number(a.dauer) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
                  "Dauer: ",
                  minutesToHHMM(Number(a.dauer))
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
                  "Status:",
                  " ",
                ...
                a.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground break-words line-clamp-3", children: a.description })
              ] })
            },
            String(a.id)
          )),
          otherAbsences.map((a) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                variant: "absence",
                label: (t == null ? void 0 : t.name) ?? "Abwesenheit",
                tooltip: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: (t == null ? void 0 : t.name) ?? "Abwesenheit" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
                    "Von: ",
                    formatDateDE(a.dateFrom)
                  ] }),
        ...
        isCompanyView && companyEntries && companyEntries.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0.5 mt-0.5 px-0.5", children: companyEntries.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            title: [
              entry.employeeName ? `${entry.employeeName}`.split(" ")[0] : null,
              entry.displayTitle,
              ["submitted", "pending", "ausstehend"].includes(
                (entry.status ?? "").toLowerCase()
              ) ? "(Ausstehend)" : entry.status === "approved" || entry.status === "genehmigt" ? "(Genehmigt)" : null
            ].filter(Boolean).join(" – "),
            children: [
        ...
        !isCompanyView && day.timeEntries.length >= 2 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          PauseIndicator,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "absolute bottom-0.5 right-0.5 w-3 h-3 text-primary opacity-0 hover:opacity-60 transition-opacity" })
      ]
    }
  );
}
function FerienFormDialog({
  ...
  reactExports.useEffect(() => {
    ...
    if (editAbsence) {
      setForm({
        ...
        dauerInput: editAbsence.ganztaetig ? "" : minutesToHHMM(Number(editAbsence.dauer))
      });
    } else {
      setForm({
        dateFrom: initialDate,
  ...
  async function handleSave() {
    ...
    try {
      if (!editAbsence && employeeId) {
        ...
        const currentYear = (/* @__PURE__ */ new Date(`${form.dateFrom}T12:00:00`)).getFullYear();
        try {
          const [balancesRes, absencesRes, typesRes, employmentsRes] = await Promise.all([
            a.listVacationBalances(empIdBig),
            a.listAbsences({ employeeId: empIdBig }),
            a.listAbsenceTypes(),
            a.listEmployments(empIdBig)
          ]);
          const freshEmployments = employmentsRes.__kind__ === "ok" ? employmentsRes.ok ?? [] : [];
          const balances = balancesRes.__kind__ === "ok" ? balancesRes.ok ?? [] : [];
          const vacTypeIds = new Set(
            (typesRes ?? []).filter(
              (t) => {
                var _a;
                return ((_a = t.name) == null ? void 0 : _a.toLowerCase()) === "ferien";
              }
            ).map((t) => String(t.id))
          );
          const totalGranted = balances.filter((b) => Number(b.kalenderjahr) === currentYear).reduce((sum, b) => sum + Number(b.dauer) / 100, 0);
          const usedDays = (absencesRes ?? []).filter((raw) => {
            const ab = raw;
            return vacTypeIds.has(String(ab.absenceTypeId)) && (ab.status === "approved" || ab.status === "submitted" || ab.status === "pending") && String(ab.employeeId) === String(empIdBig);
          }).reduce((sum, rawA) => {
            const ab = rawA;
            const yFrom = (/* @__PURE__ */ new Date(`${ab.dateFrom}T12:00:00`)).getFullYear();
            const yTo = (/* @__PURE__ */ new Date(`${ab.dateTo}T12:00:00`)).getFullYear();
            if (yFrom !== currentYear && yTo !== currentYear) return sum;
            const effFrom = yFrom < currentYear ? `${currentYear}-01-01` : ab.dateFrom;
            const effTo = yTo > currentYear ? `${currentYear}-12-31` : ab.dateTo;
            ...
            return sum + (days > 0 ? days : Math.ceil(
              (new Date(effTo).getTime() - new Date(effFrom).getTime()) / 864e5
            ) + 1);
          }, 0);
          const dauerMins = form.ganztaetig ? 0 : hhmmToMinutes(form.dauerInput) ?? 0;
          ...
          if (requestedDays === 0) {
            requestedDays = form.ganztaetig ? Math.ceil(
              (new Date(form.dateTo).getTime() - new Date(form.dateFrom).getTime()) / 864e5
            ) + 1 : Math.max(dauerMins / 480, 0.01);
          }
          ...
          const msg = "Feriensaldo konnte nicht geprüft werden. Bitte versuche es erneut.";
          ue.error(msg);
          return;
        }
      }
      const dauerMinutes = form.ganztaetig ? 0 : hhmmToMinutes(form.dauerInput) ?? 0;
      if (editAbsence) {
        const input = {
        ...
        const res = await a.updateAbsence(editAbsence.id, input);
  ...
  const isMultiDay = form.dateFrom && form.dateTo && form.dateFrom !== form.dateTo;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: editAbsence ? "Ferien bearbeiten" : "Ferien erfassen" }) }),
        errors.vacationBalance && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-red-50 border border-red-200 rounded-md p-3 text-red-700 text-sm flex items-start gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: errors.vacationBalance }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "ffd-from", children: [
                "Von ",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "ffd-to", children: [
                "Bis ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          isMultiDay && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground px-1 py-1 bg-muted/30 rounded-md", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium text-foreground", children: [
              daysBetween(form.dateFrom, form.dateTo),
              " Tage"
            ] }),
            " ",
          ...
          form.ganztaetig && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground -mt-1 pl-7", children: "Stunden werden aus der Beschäftigung je Wochentag berechnet." }),
          !form.ganztaetig && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "ffd-dauer", children: [
              "Dauer (hh:mm) ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                onChange: (e) => setForm((f) => ({ ...f, dauerInput: e.target.value })),
                onBlur: (e) => {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "ffd-desc", children: [
              "Bemerkung",
              " ",
...
function AbwesenheitFormDialog({
  ...
  const [ganztaetig, setGanztaetig] = reactExports.useState(false);
  const [errors, setErrors] = reactExports.useState({});
  const [isSaving, setIsSaving] = reactExports.useState(false);
  const isSingleDay = form.dateFrom !== "" && form.dateTo !== "" && form.dateFrom === form.dateTo;
  const isMultiDay = form.dateFrom !== "" && form.dateTo !== "" && form.dateTo > form.dateFrom;
  const defaultAbsenceTypeId = nonVacationTypes[0] ? String(nonVacationTypes[0].id) : "";
  reactExports.useEffect(() => {
    if (!open) return;
    if (editAbsence) {
      ...
      setForm({
        ...
        dateTo: editAbsence.dateTo,
        description: editAbsence.description ?? "",
        dauer: single && !editAbsence.ganztaetig ? minutesToHHMM(Number(editAbsence.dauer)) : ""
      });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: editAbsence ? "Abwesenheit bearbeiten" : "Abwesenheit erfassen" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-2", children: [
          !editAbsence && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "awd-type", children: [
              "Abwesenheitsart ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                ...
                onValueChange: (v) => setForm((f) => ({ ...f, absenceTypeId: v })),
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SelectTrigger,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Abwesenheitsart wählen…" })
                    }
                  ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "awd-from", children: [
                "Von ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "awd-to", children: [
                "Bis ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          isSingleDay && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Checkbox,
                {
            ...
            ganztaetig && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground pl-7", children: "Stunden werden aus der Beschäftigung für diesen Wochentag übernommen." }),
            !ganztaetig && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "awd-dauer", children: [
                "Dauer (hh:mm) ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  placeholder: "08:00",
                  value: form.dauer,
                  onChange: (e) => setForm((f) => ({ ...f, dauer: e.target.value })),
                  onBlur: (e) => {
                    const normalized = normalizeTimeInput(e.target.value);
              ...
              errors.dauer && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.dauer }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Eingabe: 8:00, 08:00 oder 0800 werden erkannt." })
            ] })
          ] }),
          isMultiDay && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground px-1 py-1.5 bg-muted/30 rounded-md", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium text-foreground", children: [
              daysBetween(form.dateFrom, form.dateTo),
              " Tage"
            ] }),
            " ",
            "— Dauer wird aus der Beschäftigung je Wochentag berechnet und als Einheit gespeichert."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "awd-desc", children: [
              "Bemerkung",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-normal text-xs", children: "(optional)" })
            ] }),
...
function DayDetailSheet({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-40 bg-foreground/20 backdrop-blur-sm flex items-end sm:items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ref: sheetRef,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between p-4 border-b border-border sticky top-0 bg-card z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-wide font-medium", children: "Tagesübersicht" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mt-0.5", children: dateLabel })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-5", children: [
          day.holidays.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 text-yellow-600" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: "Feiertage" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: day.holidays.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "flex items-center gap-3 p-2.5 rounded-lg bg-yellow-50/60 border border-yellow-200",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 text-yellow-600 shrink-0" }),
          ...
          day.timeEntries.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4 text-blue-600" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: "Zeiteinträge" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "ml-auto text-xs", children: [
                formatHours(totalHours),
                " Std. total"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: day.timeEntries.map((te) => {
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate", children: (proj == null ? void 0 : proj.name) ?? "Projekt" }),
                      te.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5 line-clamp-2", children: te.description })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-semibold text-blue-700 whitespace-nowrap tabular-nums", children: [
                      formatHours(te.hours),
                      " Std."
                    ] }),
                    !periodLocked && (() => {
                      ...
                      const teApproved = teStatus === "approved" || teStatus === "genehmigt";
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity ml-1", children: [
                        !teApproved && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            type: "button",
                            onClick: (e) => {
          ...
          day.expenses.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { className: "w-4 h-4 text-emerald-600" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: "Spesen" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "ml-auto text-xs", children: [
                totalExpenses.toFixed(2),
                " CHF total"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: day.expenses.map((ex) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate", children: (et == null ? void 0 : et.name) ?? "Spesenart" }),
                      ex.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5 line-clamp-2", children: ex.description })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-semibold text-emerald-700 whitespace-nowrap", children: [
                      total.toFixed(2),
                      " CHF"
                    ] })
                  ]
          ...
          day.absences.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-4 h-4 text-orange-500" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: "Abwesenheiten & Ferien" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: day.absences.map((ab) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `group flex items-start gap-3 p-2.5 rounded-lg border hover:border-opacity-60 transition-colors ${isVacation ? "bg-orange-50/60 border-orange-100 hover:border-orange-300" : "bg-muted/40 border-border hover:border-primary/30"}`,
                  "data-ocid": "day-absence-row",
                  children: [
                    isVacation ? /* @__PURE__ */ jsxRuntimeExports.jsx(TreePalm, { className: "w-4 h-4 text-orange-500 shrink-0 mt-0.5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-4 h-4 text-muted-foreground shrink-0 mt-0.5" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: (t == null ? void 0 : t.name) ?? "Abwesenheit" }),
                      isMultiDayEntry && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-0.5", children: [
                        formatDateDE(ab.dateFrom),
                        " –",
                        " ",
                        formatDateDE(ab.dateTo),
                        " (",
                        daysBetween(ab.dateFrom, ab.dateTo),
                        " Tage)"
                      ] }),
                      ab.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: ab.description })
                    ] }),
                    !periodLocked && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity ml-1 shrink-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
          ...
          day.timeEntries.length === 0 && day.expenses.length === 0 && day.absences.length === 0 && day.holidays.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center py-6 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { className: "w-10 h-10 text-muted-foreground/40 mb-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Keine Einträge für diesen Tag" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/60 mt-1", children: "Wähle unten eine Erfassungsoption" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-medium mb-2 uppercase tracking-wide", children: "Erfassen" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  title: periodLocked ? "Diese Periode ist abgeschlossen" : void 0,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-4 h-4 text-blue-600" }),
                    "Zeit"
                  ]
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  title: periodLocked ? "Diese Periode ist abgeschlossen" : void 0,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TreePalm, { className: "w-4 h-4 text-orange-500" }),
                    "Ferien"
                  ]
                }
              ),
...
function KalenderPage() {
  ...
  const [editingTimeEntry, setEditingTimeEntry] = reactExports.useState(
    null
  );
  const [timeDialogInitDate, setTimeDialogInitDate] = reactExports.useState("");
  const [ferienDialogOpen, setFerienDialogOpen] = reactExports.useState(false);
  const [editingFerienAbsence, setEditingFerienAbsence] = reactExports.useState(null);
  const [ferienDialogDate, setFerienDialogDate] = reactExports.useState("");
  const [abwesenheitDialogOpen, setAbwesenheitDialogOpen] = reactExports.useState(false);
  const [editingAbwesenheit, setEditingAbwesenheit] = reactExports.useState(
    null
  );
  const [abwesenheitDialogDate, setAbwesenheitDialogDate] = reactExports.useState("");
  ...
  const [calendarView, setCalendarView] = reactExports.useState(
    "personal"
  );
  const [companyAbsences, setCompanyAbsences] = reactExports.useState([]);
  const [onlyShowFerien, setOnlyShowFerien] = reactExports.useState(false);
  const [companyCalFilter, setCompanyCalFilter] = reactExports.useState(
    "all"
  );
  const [loadingCompanyAbsences, setLoadingCompanyAbsences] = reactExports.useState(false);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    ...
    a.getCompanyCalendarAbsences(
      BigInt(companyId),
      BigInt(firstVisibleDay.getTime()) * 1000000n,
      BigInt(lastVisibleDay.getTime()) * 1000000n
    ).then((absences) => {
      const unwrapOpt = (v) => Array.isArray(v) ? v[0] ?? "" : v ?? "";
      const unwrapStatus = (v) => {
      ...
      setCompanyAbsences(
        absences.map((abs) => ({
          ...
          displayTitle: typeof abs.displayTitle === "string" ? abs.displayTitle : unwrapOpt(abs.displayTitle),
      ...
      (err) => console.error("[Firmenkalender] error loading company absences:", err)
  ...
  const { data: calendarPrevData } = useQuery({
  ...
  const { data: absenceTypes = [] } = useQuery({
    ...
    queryFn: async () => a ? a.listAbsenceTypes() : [],
    enabled: !!a && !actorFetching
  });
  const { data: expenseTypes = [] } = useQuery({
    queryKey: ["expenseTypes"],
    queryFn: async () => a ? a.listExpenseTypes() : [],
    enabled: !!a && !actorFetching
  });
  const { data: projects = [] } = useQuery({
    queryKey: ["projects"],
    queryFn: async () => a ? a.listProjects() : [],
    enabled: !!a && !actorFetching
  });
  const { data: holidays = [] } = useQuery({
    queryKey: ["holidays"],
    queryFn: async () => a ? a.listHolidays() : [],
    enabled: !!a && !actorFetching
  });
  const { data: employments = [], isLoading: employmentsLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      try {
        const res = await a.listEmployments(BigInt(employeeId));
  ...
  function getSollMinutesForDate(iso) {
  ...
  function buildDayData(d) {
    const iso = isoDate(d);
    const entries = [
      ...(calendarData == null ? void 0 : calendarData.timeEntries) ?? [],
      ...(calendarPrevData == null ? void 0 : calendarPrevData.timeEntries) ?? []
    ];
    const expList = [
      ...(calendarData == null ? void 0 : calendarData.expenses) ?? [],
      ...(calendarPrevData == null ? void 0 : calendarPrevData.expenses) ?? []
    ];
    const absences = [
      ...(calendarData == null ? void 0 : calendarData.absences) ?? [],
      ...(calendarPrevData == null ? void 0 : calendarPrevData.absences) ?? []
    ];
  ...
  function handleAction(mode) {
    ...
    if (mode.kind === "zeit") {
      ...
      const zeitStatus = String(mode.entry.status);
      if (zeitStatus === "approved" || zeitStatus === "genehmigt" || zeitStatus === "Genehmigt") {
        ue.error(
      ...
      const absStatus = String(mode.absence.status);
      if (absStatus === "approved" || absStatus === "genehmigt" || absStatus === "Genehmigt") {
        ue.error(
          "Dieser Eintrag wurde bereits genehmigt. Bitte den Vorgesetzten bitten, die Genehmigung zuerst zurückzusetzen."
        );
        return;
  ...
  async function handleConfirmDelete() {
    ...
    const entryStatusStr = deleteTarget.kind === "absence" ? String(deleteTarget.absence.status) : String(deleteTarget.entry.status);
    if (entryStatusStr === "approved" || entryStatusStr === "genehmigt" || entryStatusStr === "Genehmigt") {
      ue.error(
        "Dieser Eintrag wurde bereits genehmigt. Bitte den Vorgesetzten bitten, die Genehmigung zuerst zurückzusetzen."
      );
      return;
    ...
    try {
      if (deleteTarget.kind === "zeit") {
        const res = await a.deleteTimeEntry(deleteTarget.entry.id);
        if (res.__kind__ === "err") throw new Error(res.err);
        ue.success("Zeiteintrag gelöscht");
      } else {
        const res = await a.deleteAbsence(deleteTarget.absence.id);
        if (res.__kind__ === "err") throw new Error(res.err);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 sm:p-6 space-y-4", "data-ocid": "kalender-page", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start justify-between gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold text-foreground", children: "Kalenderübersicht" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Monatsansicht aller Einträge — auf einen Tag tippen zum Erfassen" })
      ] }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl shadow-card overflow-hidden", children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: "Firmenkalender"
                }
              ),
              calendarView === "company" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                loadingCompanyAbsences && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "select",
                  {
                    ...
                    onChange: (e) => setCompanyCalFilter(e.target.value),
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "mine", children: "Meine Einträge" })
                    ]
                  }
                )
              ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline text-xs", children: "Vorheriger Monat" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-semibold text-foreground text-lg", children: [
            GERMAN_MONTHS[currentMonth],
            " ",
            currentYear
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              className: "gap-1.5 text-muted-foreground hover:text-foreground",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline text-xs", children: "Nächster Monat" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-2 text-center text-xs font-semibold uppercase tracking-wide text-muted-foreground/40", children: "KW" }),
              GERMAN_DAYS.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `py-2 text-center text-xs font-semibold uppercase tracking-wide ${d === "Sa" || d === "So" ? "text-muted-foreground/60" : "text-muted-foreground"}`,
                  children: d
                },
                d
              ))
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-px bg-border", children: ["r0", "r1", "r2", "r3", "r4"].map((rk) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "grid gap-px bg-border",
            style: { gridTemplateColumns: "2.5rem repeat(7, 1fr)" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[90px] bg-muted/20" }),
              ["c0", "c1", "c2", "c3", "c4", "c5", "c6"].map((ck) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Skeleton,
                {
          ...
          rk
        )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-px bg-border", children: Array.from(
          ...
          (_, rowIdx) => {
            ...
            const rowKey = firstDate ? isoDate(firstDate) : `row-${rowIdx}`;
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "grid gap-px bg-border",
                style: { gridTemplateColumns: "2.5rem repeat(7, 1fr)" },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center bg-muted/20 text-[0.65rem] text-muted-foreground/50 font-medium", children: kwNum > 0 ? `KW ${kwNum}` : "" }),
                  row.map((d, colIdx) => {
                      ...
                      motion.div,
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          DayCell,
                          {
                            ...
                            noSollHours: !employmentsLoading && getSollMinutesForDate(cellKey) === 0,
                            isCompanyView: calendarView === "company",
                            companyEntries: calendarView === "company" && d ? (() => {
                              ...
                              return companyAbsences.filter((abs) => {
                                const fromStr = abs.fromDate ?? "";
                                const toStr = abs.toDate ?? "";
                                if (onlyShowFerien && !abs.displayTitle.toLowerCase().includes("ferien"))
                                  return false;
                                if (companyCalFilter === "mine" && !abs.isOwnEntry)
                                  return false;
                                return fromStr <= cellIso && cellIso <= toStr && abs.status !== "rejected" && abs.status !== "abgelehnt";
                              });
                            })() : void 0
                          }
                        )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 px-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide mr-1", children: "Legende:" }),
        [
          {
          ...
          },
          {
            ...
            label: "Spesen",
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Receipt, { className: "w-3 h-3" })
          },
          {
            className: "bg-orange-100 text-orange-800 border-orange-200",
            label: "Ferien",
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TreePalm, { className: "w-3 h-3" })
          },
          {
        ...
        ].map(({ className, label, icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-2 py-1 rounded text-xs font-medium border border-primary/40 text-primary bg-primary/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 rounded-sm border border-primary inline-block" }),
          "Heute"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: selectedDay && /* @__PURE__ */ jsxRuntimeExports.jsx(
      DayDetailSheet,
      {
        day: selectedDay,
        absenceTypes,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      TimeEntryDialog,
      {
        ...
        initialValues: timeDialogInitDate ? { date: timeDialogInitDate } : void 0,
