import { R as React, a as useNavigate, b as useSearch, u as useInternetIdentity, r as reactExports, j as jsxRuntimeExports } from "./index-D_yjRFGt.js";
import { B as Button } from "./button-BXNzWYpr.js";
import { C as Card, b as CardHeader, c as CardTitle, d as CardDescription, a as CardContent } from "./card-Cqx-QXhC.js";
...
function RegisterPage() {
  ...
  const billingInterval = search.billing ?? "monthly";
  const { identity, login } = useInternetIdentity();
  const { actor } = useActor(createActor);
  const { setAuthenticated, isAuthenticated, companyId, setPlatformAdmin } = useAuthStore();
  ...
  reactExports.useEffect(() => {
    ...
    actor.getSubscriptionPlans().then((plans) => {
  ...
  const onSubmit = async (data) => {
    ...
    if (!actor) {
      ue.error("Backend nicht verfügbar. Bitte versuchen Sie es erneut.");
      return;
    }
    setIsSubmitting(true);
    try {
      const planIdArg = typeof planId === "string" && planId ? planId : null;
      const billingArg = typeof billingInterval === "string" && billingInterval ? billingInterval : null;
      ...
      ue.success("Unternehmen erfolgreich registriert!");
      navigate({ to: "/dashboard" });
    } catch (err) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "shadow-elevated", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-2xl text-foreground", children: "Unternehmen registrieren" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Erstellen Sie Ihr iReport-Konto für Ihr Unternehmen." }),
      planId && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex flex-col gap-1 rounded-lg border border-border bg-muted/50 px-4 py-3 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Gewählter Plan" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: planName || planId })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Abonnement" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: billingInterval === "yearly" ? "Jährlich" : "Monatlich" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: needsLogin ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center", children: "Bitte melden Sie sich mit Internet Identity an, um die Registrierung fortzusetzen." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          size: "lg",
          onClick: () => login(),
          children: "Mit Internet Identity anmelden"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          size: "sm",
          onClick: () => navigate({ to: "/", search: { scroll: "pricing" } }),
      ...
      "form",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "companyName", children: "Firmenname *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "companyName",
            ...
            errors.companyName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.companyName.message })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "firstName", children: "Vorname *" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "firstName",
              ...
              errors.firstName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.firstName.message })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "lastName", children: "Nachname *" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "lastName",
              ...
              errors.lastName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.lastName.message })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "email", children: "E-Mail-Adresse *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "email",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              size: "lg",
              children: isSubmitting ? "Registrierung läuft…" : "Jetzt registrieren"
            }
          )
        ]
      }
