...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, z as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, A as lookupResultToBuffer, B as RequestStatusResponseStatus, U as UnknownError, D as RequestStatusDoneNoReplyErrorCode, F as RejectError, G as CertifiedRejectErrorCode, H as UNREACHABLE_ERROR, I as InputError, J as InvalidReadStateRequestErrorCode, K as ReadRequestType, L as Principal, N as IDL, O as MissingCanisterIdErrorCode, Q as HttpAgent, V as encode, W as QueryResponseStatus, X as UncertifiedRejectErrorCode, Y as isV3ResponseBody, Z as isV2ResponseBody, $ as UncertifiedRejectUpdateErrorCode, a0 as UnexpectedErrorCode, a1 as decode, k as Subscribable, a2 as pendingThenable, a3 as resolveEnabled, s as shallowEqualObjects, a4 as resolveStaleTime, o as noop, a5 as environmentManager, a6 as isValidTimeout, a7 as timeUntilStale, a8 as timeoutManager, a9 as focusManager, aa as fetchState, ab as replaceData, n as notifyManager, r as reactExports, p as shouldThrowError, d as useQueryClient, u as useInternetIdentity, ac as createActorWithConfig, R as React, ad as Record, ae as Opt, af as Variant, ag as Vec, ah as Text, ai as Nat, aj as Service, ak as Func, al as Bool, am as Int, an as Principal$1, ao as Tuple, ap as Nat8, aq as Float64, ar as Null } from "./index-Blf-A8DR.js";
...
const Result_19 = Variant({ "ok": Absence, "err": Text });
const AbsenceApprovalInput = Record({
  "reason": Opt(Text)
});
...
const Result_11 = Variant({ "ok": Expense, "err": Text });
const TimeEntryId = Nat;
const TimeEntryApprovalInput = Record({
  "reason": Opt(Text)
});
const ProjectId = Nat;
...
const Result_8 = Variant({ "ok": Invoice, "err": Text });
...
const FeatureKey = Text;
const FeatureAccessResult = Record({
...
const Result_18 = Variant({ "ok": AbsenceType, "err": Text });
...
const Result_15 = Variant({ "ok": Customer, "err": Text });
const Role = Variant({
  "manager": Null,
  "admin": Null,
  "employee": Null
...
const Result_13 = Variant({ "ok": Employee, "err": Text });
...
const Result_12 = Variant({ "ok": Employment, "err": Text });
...
const Result_10 = Variant({ "ok": ExpenseType, "err": Text });
...
const Result_9 = Variant({ "ok": Holiday, "err": Text });
...
const EmployeeComplianceProfile = Record({
  ...
  "vertraglicheWochenstunden": Float64,
...
const Result_17 = Variant({ "ok": Company, "err": Text });
...
const PlatformAdminConfigPublic = Record({
  "frontendCanisterId": Text,
  "stripeWebhookEndpointUrl": Text,
  "stripePublishableKey": Text
});
const Result_31 = Variant({ "ok": Float64, "err": Text });
...
const Result_27 = Variant({ "ok": Int, "err": Text });
...
const TimeEntryApprovalAuditEntry = Record({
  "id": Nat,
  "oldStatus": Text,
  "action": Text,
...
const PlatformAdminConfig = Record({
  "frontendCanisterId": Text,
  "stripeWebhookEndpointUrl": Text,
...
Service({
  ...
  "approveAbsence": Func([AbsenceId], [Result_19], []),
  "approveAbsenceApproval": Func(
    [AbsenceId, AbsenceApprovalInput],
    [Result_5],
    []
  ),
  "approveExpense": Func([ExpenseId], [Result_11], []),
  "approveTimeEntry": Func(
  ...
  "cancelInvoice": Func([Nat], [Result_8], []),
  "cancelStripeSubscription": Func([Nat], [Result_20], []),
  "checkFeatureAccess": Func(
    [FeatureKey],
    [FeatureAccessResult],
    ["query"]
  ),
  "checkPlanChangeNeeded": Func([Nat], [Result_44], ["query"]),
  "compareStripeSubscriptionStatus": Func([Nat], [Result_43], []),
  "createAbsence": Func([CreateAbsenceInput], [Result_19], []),
  "createAbsenceType": Func([CreateAbsenceTypeInput], [Result_18], []),
  "createCustomer": Func([CreateCustomerInput], [Result_15], []),
  "createEmployee": Func([CreateEmployeeInput], [Result_13], []),
  "createEmployment": Func(
    [EmployeeId, CreateEmploymentInput],
    [Result_12],
    []
  ),
  "createExpense": Func([CreateExpenseInput], [Result_11], []),
  "createExpenseType": Func([CreateExpenseTypeInput], [Result_10], []),
  "createHoliday": Func([CreateHolidayInput], [Result_9], []),
  "createInvoice": Func([CreateInvoiceInput], [Result_8], []),
  ...
  "createStripeCustomerPortalSession": Func([Nat], [Result_37], []),
  ...
  "getCompanyBillingModel": Func([Nat], [Result_36], ["query"]),
  ...
  "getCompanySettings": Func([], [Result_16], ["query"]),
  ...
  "getInvoiceById": Func([Nat], [Result_8], ["query"]),
  "getInvoiceTemplate": Func([], [Result_33], ["query"]),
  "getInvoices": Func([], [Result_32], []),
  "getMonthlyBillingOverview": Func(
    [Nat, Nat],
    [Vec(MonthlyBillingEntry)],
    ["query"]
  ),
  "getMyCompany": Func([], [Result_17], ["query"]),
  ...
  "getMyEmployee": Func([], [Result_13], ["query"]),
  "getMyPlanFeatures": Func([], [Vec(FeatureKey)], ["query"]),
  "getMyStandardarbeitszeiten": Func([], [Result_28], ["query"]),
  ...
  "getProjectAufwendungen": Func([ProjectId], [Result_31], ["query"]),
  "getProjectBudgetReport": Func(
    [ProjectId, Text, Text],
    [Result_30],
    ["query"]
  ),
  "getProjectMembers": Func([ProjectId], [Result_29], ["query"]),
  ...
  "getTimeBalance": Func([EmployeeId], [Result_27], ["query"]),
  "getTimeEntryApprovalStatus": Func(
    [TimeEntryId],
    [Opt(TimeEntryStatus)],
    ["query"]
  ),
  "getUnbilledEntries": Func([Opt(Nat)], [Result_26], ["query"]),
  ...
  "listApprovalAuditLog": Func(
    [],
    [Vec(TimeEntryApprovalAuditEntry)],
    ["query"]
  ),
  "listAuditLog": Func(
    [Opt(Text), Opt(Nat)],
  ...
  "listEmployments": Func([EmployeeId], [Result_24], ["query"]),
  ...
  "listSubmittedTimeEntries": Func([], [Vec(TimeEntry)], ["query"]),
  "listTimeBalanceCorrections": Func([EmployeeId], [Result_23], ["query"]),
  "listTimeEntries": Func(
    [TimeEntryFilter],
    [Vec(TimeEntry)],
    ["query"]
  ),
  "listVacationBalances": Func([EmployeeId], [Result_22], ["query"]),
  ...
  "reactivateStripeSubscription": Func([Nat], [Result_20], []),
  "recordCycleSnapshot": Func([Nat, Nat], [], []),
  "recoverSubscriptionPlans": Func([], [Result_21], []),
  "redeemInviteCode": Func([Text], [Result_13], []),
  "registerCompany": Func(
    [Text, Text, Text, Text],
    [Result_17],
    []
  ),
  "rejectAbsence": Func([AbsenceId, Text], [Result_19], []),
  "rejectAbsenceApproval": Func(
    [AbsenceId, AbsenceApprovalInput],
    [Result_5],
    []
  ),
  "rejectExpense": Func([ExpenseId, Opt(Text)], [Result_11], []),
  "rejectTimeEntry": Func(
    [TimeEntryId, TimeEntryApprovalInput],
    [Result_3],
    []
  ),
  ...
  "resetAbsenceApprovalToDraft": Func(
    [AbsenceId, Opt(Text)],
    [Result_5],
    []
  ),
  "resetAbsenceToAusstehend": Func([AbsenceId, Text], [Result_19], []),
  "resetExpenseToAusstehend": Func([ExpenseId, Text], [Result_11], []),
  "resetTimeEntryToDraft": Func(
    [TimeEntryId, Opt(Text)],
    [Result_3],
    []
  ),
  "resolveFinding": Func(
  ...
  "setEmployeeActive": Func([EmployeeId, Bool], [Result_13], []),
  ...
  "setPlatformAdminConfig": Func([PlatformAdminConfig], [Result_5], []),
  ...
  "submitAbsenceForApproval": Func([AbsenceId], [Result_5], []),
  "submitTimeEntryForApproval": Func([TimeEntryId], [Result_3], []),
  "syncStripeSubscription": Func([Nat], [Result_20], []),
  ...
  "updateAbsence": Func([AbsenceId, UpdateAbsenceInput], [Result_19], []),
  "updateAbsenceType": Func(
    [AbsenceTypeId, UpdateAbsenceTypeInput],
    [Result_18],
    []
  ),
  "updateCompany": Func([UpdateCompanyInput], [Result_17], []),
  "updateCompanySettings": Func([CompanySettings], [Result_16], []),
  ...
  "updateDefaultWorkHours": Func([DefaultWorkHours], [Result_14], []),
  "updateEmployee": Func(
  ...
  "updateExpense": Func([ExpenseId, UpdateExpenseInput], [Result_11], []),
  "updateExpenseType": Func(
    [ExpenseTypeId, UpdateExpenseTypeInput],
    [Result_10],
    []
  ),
  "updateHoliday": Func([HolidayId, UpdateHolidayInput], [Result_9], []),
  "updateInvoice": Func([Nat, UpdateInvoiceInput], [Result_8], []),
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const Result_192 = IDL2.Variant({ "ok": Absence2, "err": IDL2.Text });
  const AbsenceApprovalInput2 = IDL2.Record({ "reason": IDL2.Opt(IDL2.Text) });
  ...
  const Result_112 = IDL2.Variant({ "ok": Expense2, "err": IDL2.Text });
  const TimeEntryId2 = IDL2.Nat;
  const TimeEntryApprovalInput2 = IDL2.Record({ "reason": IDL2.Opt(IDL2.Text) });
  ...
  const Result_39 = IDL2.Variant({ "ok": TimeEntry2, "err": IDL2.Text });
  ...
  const Result_462 = IDL2.Variant({ "ok": ProjectAssignment2, "err": IDL2.Text });
  ...
  const Result_82 = IDL2.Variant({ "ok": Invoice2, "err": IDL2.Text });
  ...
  const FeatureKey2 = IDL2.Text;
  const FeatureAccessResult2 = IDL2.Record({
  ...
  const Result_182 = IDL2.Variant({ "ok": AbsenceType2, "err": IDL2.Text });
  ...
  const Result_152 = IDL2.Variant({ "ok": Customer2, "err": IDL2.Text });
  ...
  const Result_132 = IDL2.Variant({ "ok": Employee2, "err": IDL2.Text });
  ...
  const Result_122 = IDL2.Variant({ "ok": Employment2, "err": IDL2.Text });
  ...
  const Result_102 = IDL2.Variant({ "ok": ExpenseType2, "err": IDL2.Text });
  ...
  const Result_92 = IDL2.Variant({ "ok": Holiday2, "err": IDL2.Text });
  ...
  const Result_422 = IDL2.Variant({ "ok": InvoiceTemplate2, "err": IDL2.Text });
  ...
  const TimeEntryStatus2 = IDL2.Variant({
    "submitted": IDL2.Null,
    "approved": IDL2.Null,
    "rejected": IDL2.Null,
    "draft": IDL2.Null
  ...
  const Result_162 = IDL2.Variant({ "ok": CompanySettings2, "err": IDL2.Text });
  ...
  const EmployeeComplianceProfile2 = IDL2.Record({
    ...
    "vertraglicheWochenstunden": IDL2.Float64,
  ...
  const Result_352 = IDL2.Variant({ "ok": WorkTimeBalance2, "err": IDL2.Text });
  ...
  const Result_322 = IDL2.Variant({ "ok": IDL2.Vec(Invoice2), "err": IDL2.Text });
  ...
  const Result_172 = IDL2.Variant({ "ok": Company2, "err": IDL2.Text });
  ...
  const PlatformAdminConfigPublic2 = IDL2.Record({
    "frontendCanisterId": IDL2.Text,
    "stripeWebhookEndpointUrl": IDL2.Text,
    "stripePublishableKey": IDL2.Text
  });
  const Result_312 = IDL2.Variant({ "ok": IDL2.Float64, "err": IDL2.Text });
  ...
  const Result_272 = IDL2.Variant({ "ok": IDL2.Int, "err": IDL2.Text });
  ...
  const TimeEntryApprovalAuditEntry2 = IDL2.Record({
    "id": IDL2.Nat,
    "oldStatus": IDL2.Text,
    "action": IDL2.Text,
  ...
  const PlatformAdminConfig2 = IDL2.Record({
    "frontendCanisterId": IDL2.Text,
    "stripeWebhookEndpointUrl": IDL2.Text,
  ...
  const Result_142 = IDL2.Variant({ "ok": DefaultWorkHours2, "err": IDL2.Text });
  ...
  return IDL2.Service({
    ...
    "approveAbsence": IDL2.Func([AbsenceId2], [Result_192], []),
    "approveAbsenceApproval": IDL2.Func(
      [AbsenceId2, AbsenceApprovalInput2],
      [Result_52],
      []
    ),
    "approveExpense": IDL2.Func([ExpenseId2], [Result_112], []),
    "approveTimeEntry": IDL2.Func(
      [TimeEntryId2, TimeEntryApprovalInput2],
      [Result_39],
      []
    ),
    ...
    "cancelInvoice": IDL2.Func([IDL2.Nat], [Result_82], []),
    "cancelStripeSubscription": IDL2.Func([IDL2.Nat], [Result_202], []),
    "checkFeatureAccess": IDL2.Func(
      [FeatureKey2],
      [FeatureAccessResult2],
      ["query"]
    ),
    "checkPlanChangeNeeded": IDL2.Func([IDL2.Nat], [Result_442], ["query"]),
    "compareStripeSubscriptionStatus": IDL2.Func([IDL2.Nat], [Result_432], []),
    "createAbsence": IDL2.Func([CreateAbsenceInput2], [Result_192], []),
    "createAbsenceType": IDL2.Func([CreateAbsenceTypeInput2], [Result_182], []),
    "createCustomer": IDL2.Func([CreateCustomerInput2], [Result_152], []),
    "createEmployee": IDL2.Func([CreateEmployeeInput2], [Result_132], []),
    "createEmployment": IDL2.Func(
      [EmployeeId2, CreateEmploymentInput2],
      [Result_122],
      []
    ),
    "createExpense": IDL2.Func([CreateExpenseInput2], [Result_112], []),
    "createExpenseType": IDL2.Func([CreateExpenseTypeInput2], [Result_102], []),
    "createHoliday": IDL2.Func([CreateHolidayInput2], [Result_92], []),
    "createInvoice": IDL2.Func([CreateInvoiceInput2], [Result_82], []),
    ...
    "createStripeCustomerPortalSession": IDL2.Func([IDL2.Nat], [Result_372], []),
    "createTimeBalanceCorrection": IDL2.Func(
      [EmployeeId2, CreateTimeBalanceCorrectionInput2],
      [Result_47],
      []
    ),
    "createTimeEntry": IDL2.Func([CreateTimeEntryInput2], [Result_39], []),
    ...
    "getAbsenceApprovalStatus": IDL2.Func(
      [AbsenceId2],
      [
        IDL2.Opt(
          IDL2.Record({
            "status": TimeEntryStatus2,
            "approvedBy": IDL2.Opt(IDL2.Principal),
            "reason": IDL2.Opt(IDL2.Text)
          })
        )
    ...
    "getCompanyBillingModel": IDL2.Func([IDL2.Nat], [Result_362], ["query"]),
    ...
    "getCompanySettings": IDL2.Func([], [Result_162], ["query"]),
    ...
    "getInvoiceById": IDL2.Func([IDL2.Nat], [Result_82], ["query"]),
    "getInvoiceTemplate": IDL2.Func([], [Result_332], ["query"]),
    "getInvoices": IDL2.Func([], [Result_322], []),
    "getMonthlyBillingOverview": IDL2.Func(
      [IDL2.Nat, IDL2.Nat],
      [IDL2.Vec(MonthlyBillingEntry2)],
      ["query"]
    ),
    "getMyCompany": IDL2.Func([], [Result_172], ["query"]),
    ...
    "getMyEmployee": IDL2.Func([], [Result_132], ["query"]),
    "getMyPlanFeatures": IDL2.Func([], [IDL2.Vec(FeatureKey2)], ["query"]),
    "getMyStandardarbeitszeiten": IDL2.Func([], [Result_282], ["query"]),
    ...
    "getProjectAufwendungen": IDL2.Func([ProjectId2], [Result_312], ["query"]),
    "getProjectBudgetReport": IDL2.Func(
      [ProjectId2, IDL2.Text, IDL2.Text],
      [Result_302],
      ["query"]
    ),
    "getProjectMembers": IDL2.Func([ProjectId2], [Result_292], ["query"]),
    ...
    "getTimeBalance": IDL2.Func([EmployeeId2], [Result_272], ["query"]),
    "getTimeEntryApprovalStatus": IDL2.Func(
      [TimeEntryId2],
      [IDL2.Opt(TimeEntryStatus2)],
      ["query"]
    ),
    "getUnbilledEntries": IDL2.Func([IDL2.Opt(IDL2.Nat)], [Result_262], ["query"]),
    ...
    "listApprovalAuditLog": IDL2.Func(
      [],
      [IDL2.Vec(TimeEntryApprovalAuditEntry2)],
      ["query"]
    ),
    ...
    "listEmployments": IDL2.Func([EmployeeId2], [Result_242], ["query"]),
    ...
    "listSubmittedTimeEntries": IDL2.Func([], [IDL2.Vec(TimeEntry2)], ["query"]),
    ...
    "listVacationBalances": IDL2.Func([EmployeeId2], [Result_222], ["query"]),
    ...
    "reactivateStripeSubscription": IDL2.Func([IDL2.Nat], [Result_202], []),
    "recordCycleSnapshot": IDL2.Func([IDL2.Nat, IDL2.Nat], [], []),
    "recoverSubscriptionPlans": IDL2.Func([], [Result_212], []),
    "redeemInviteCode": IDL2.Func([IDL2.Text], [Result_132], []),
    "registerCompany": IDL2.Func(
      [IDL2.Text, IDL2.Text, IDL2.Text, IDL2.Text],
      [Result_172],
      []
    ),
    "rejectAbsence": IDL2.Func([AbsenceId2, IDL2.Text], [Result_192], []),
    "rejectAbsenceApproval": IDL2.Func(
      [AbsenceId2, AbsenceApprovalInput2],
      [Result_52],
      []
    ),
    "rejectExpense": IDL2.Func([ExpenseId2, IDL2.Opt(IDL2.Text)], [Result_112], []),
    "rejectTimeEntry": IDL2.Func(
      [TimeEntryId2, TimeEntryApprovalInput2],
      [Result_39],
      []
    ),
    ...
    "resetAbsenceApprovalToDraft": IDL2.Func(
      [AbsenceId2, IDL2.Opt(IDL2.Text)],
      [Result_52],
      []
    ),
    ...
    "resetTimeEntryToDraft": IDL2.Func(
      [TimeEntryId2, IDL2.Opt(IDL2.Text)],
      [Result_39],
      []
    ),
    ...
    "setEmployeeActive": IDL2.Func([EmployeeId2, IDL2.Bool], [Result_132], []),
    ...
    "setPlatformAdminConfig": IDL2.Func([PlatformAdminConfig2], [Result_52], []),
    ...
    "submitAbsenceForApproval": IDL2.Func([AbsenceId2], [Result_52], []),
    "submitTimeEntryForApproval": IDL2.Func([TimeEntryId2], [Result_39], []),
    "syncStripeSubscription": IDL2.Func([IDL2.Nat], [Result_202], []),
    ...
    "updateCompany": IDL2.Func([UpdateCompanyInput2], [Result_172], []),
    "updateCompanySettings": IDL2.Func([CompanySettings2], [Result_162], []),
    ...
    "updateDefaultWorkHours": IDL2.Func([DefaultWorkHours2], [Result_142], []),
    ...
    "updateHoliday": IDL2.Func([HolidayId2, UpdateHolidayInput2], [Result_92], []),
    "updateInvoice": IDL2.Func([IDL2.Nat, UpdateInvoiceInput2], [Result_82], []),
...
class Backend {
  ...
  async approveAbsenceApproval(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async approveTimeEntry(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async getAbsenceApprovalStatus(arg0) {
    if (this.processError) {
      try {
  ...
  async getTimeEntryApprovalStatus(arg0) {
    if (this.processError) {
      try {
  ...
  async listSubmittedTimeEntries() {
    if (this.processError) {
      try {
  ...
  async rejectAbsenceApproval(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async rejectTimeEntry(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async resetAbsenceApprovalToDraft(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async resetTimeEntryToDraft(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async runWeeklyComplianceCheck(arg0) {
    if (this.processError) {
      try {
  ...
  async submitAbsenceForApproval(arg0) {
    if (this.processError) {
      try {
  ...
  async submitTimeEntryForApproval(arg0) {
    if (this.processError) {
      try {
...
function from_candid_AbsenceStatus_n16(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n17(_uploadFile, _downloadFile, value);
}
function from_candid_AbsenceTypeVisibility_n81(_uploadFile, _downloadFile, value) {
  return from_candid_record_n82(_uploadFile, _downloadFile, value);
}
function from_candid_AbsenceType_n78(_uploadFile, _downloadFile, value) {
  return from_candid_record_n79(_uploadFile, _downloadFile, value);
}
function from_candid_Absence_n14(_uploadFile, _downloadFile, value) {
  return from_candid_record_n15(_uploadFile, _downloadFile, value);
}
function from_candid_AuditEntityType_n354(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n355(_uploadFile, _downloadFile, value);
}
function from_candid_AuditEntry_n341(_uploadFile, _downloadFile, value) {
  return from_candid_record_n342(_uploadFile, _downloadFile, value);
}
function from_candid_AuditLogEntry_n350(_uploadFile, _downloadFile, value) {
  return from_candid_record_n351(_uploadFile, _downloadFile, value);
}
function from_candid_AuditOperation_n352(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n353(_uploadFile, _downloadFile, value);
}
function from_candid_BillingModel_n61(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n62(_uploadFile, _downloadFile, value);
}
function from_candid_CalendarData_n219(_uploadFile, _downloadFile, value) {
  return from_candid_record_n220(_uploadFile, _downloadFile, value);
}
function from_candid_CalendarVisibilityMode_n83(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n84(_uploadFile, _downloadFile, value);
}
function from_candid_CompanySubscription_n59(_uploadFile, _downloadFile, value) {
  return from_candid_record_n60(_uploadFile, _downloadFile, value);
}
function from_candid_Company_n276(_uploadFile, _downloadFile, value) {
  return from_candid_record_n277(_uploadFile, _downloadFile, value);
}
function from_candid_ComplianceCockpitRow_n237(_uploadFile, _downloadFile, value) {
  return from_candid_record_n238(_uploadFile, _downloadFile, value);
}
function from_candid_ComplianceFinding_n249(_uploadFile, _downloadFile, value) {
  return from_candid_record_n250(_uploadFile, _downloadFile, value);
}
function from_candid_CompliancePeriodeTyp_n254(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n255(_uploadFile, _downloadFile, value);
}
function from_candid_ComplianceResolutionType_n252(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n253(_uploadFile, _downloadFile, value);
}
function from_candid_ComplianceStatus_n239(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n240(_uploadFile, _downloadFile, value);
}
function from_candid_CostDashboardData_n259(_uploadFile, _downloadFile, value) {
  return from_candid_record_n260(_uploadFile, _downloadFile, value);
}
function from_candid_Customer_n93(_uploadFile, _downloadFile, value) {
  return from_candid_record_n94(_uploadFile, _downloadFile, value);
}
function from_candid_CycleStatus_n261(_uploadFile, _downloadFile, value) {
  return from_candid_record_n262(_uploadFile, _downloadFile, value);
}
function from_candid_EmployeeComplianceProfile_n257(_uploadFile, _downloadFile, value) {
  return from_candid_record_n258(_uploadFile, _downloadFile, value);
}
function from_candid_Employee_n108(_uploadFile, _downloadFile, value) {
  return from_candid_record_n109(_uploadFile, _downloadFile, value);
}
function from_candid_EmploymentType_n112(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n113(_uploadFile, _downloadFile, value);
}
function from_candid_Employment_n120(_uploadFile, _downloadFile, value) {
  return from_candid_record_n121(_uploadFile, _downloadFile, value);
}
function from_candid_Erfassungsart_n183(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n184(_uploadFile, _downloadFile, value);
}
function from_candid_ExpenseStatus_n28(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n29(_uploadFile, _downloadFile, value);
}
function from_candid_Expense_n26(_uploadFile, _downloadFile, value) {
  return from_candid_record_n27(_uploadFile, _downloadFile, value);
}
function from_candid_FeiertagsberechnungsartType_n122(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n123(_uploadFile, _downloadFile, value);
}
function from_candid_InvoicePositionTyp_n55(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n56(_uploadFile, _downloadFile, value);
}
function from_candid_InvoicePosition_n53(_uploadFile, _downloadFile, value) {
  return from_candid_record_n54(_uploadFile, _downloadFile, value);
}
function from_candid_InvoiceStatus_n50(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n51(_uploadFile, _downloadFile, value);
}
function from_candid_InvoiceTemplate_n163(_uploadFile, _downloadFile, value) {
  return from_candid_record_n164(_uploadFile, _downloadFile, value);
}
function from_candid_Invoice_n48(_uploadFile, _downloadFile, value) {
  return from_candid_record_n49(_uploadFile, _downloadFile, value);
}
function from_candid_KundeZeiterfassungsart_n98(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n99(_uploadFile, _downloadFile, value);
}
function from_candid_MaskedCalendarAbsence_n230(_uploadFile, _downloadFile, value) {
  return from_candid_record_n231(_uploadFile, _downloadFile, value);
}
function from_candid_MonthlyBillingEntry_n40(_uploadFile, _downloadFile, value) {
  return from_candid_record_n41(_uploadFile, _downloadFile, value);
}
function from_candid_NotificationFormat_n153(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n154(_uploadFile, _downloadFile, value);
}
function from_candid_NotificationPriority_n157(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n158(_uploadFile, _downloadFile, value);
}
function from_candid_NotificationStatus_n151(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n152(_uploadFile, _downloadFile, value);
}
function from_candid_NotificationTargetType_n155(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n156(_uploadFile, _downloadFile, value);
}
function from_candid_Notification_n149(_uploadFile, _downloadFile, value) {
  return from_candid_record_n150(_uploadFile, _downloadFile, value);
}
function from_candid_PauseOverride_n168(_uploadFile, _downloadFile, value) {
  return from_candid_record_n169(_uploadFile, _downloadFile, value);
}
function from_candid_PaymentProvider_n217(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n218(_uploadFile, _downloadFile, value);
}
function from_candid_PlatformAdminUserEntry_n325(_uploadFile, _downloadFile, value) {
  return from_candid_record_n326(_uploadFile, _downloadFile, value);
}
function from_candid_ProjectMemberAssignment_n295(_uploadFile, _downloadFile, value) {
  return from_candid_record_n296(_uploadFile, _downloadFile, value);
}
function from_candid_ProjectStatus_n180(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n181(_uploadFile, _downloadFile, value);
}
function from_candid_Project_n178(_uploadFile, _downloadFile, value) {
  return from_candid_record_n179(_uploadFile, _downloadFile, value);
}
function from_candid_Rechnungsadresse_n96(_uploadFile, _downloadFile, value) {
  return from_candid_record_n97(_uploadFile, _downloadFile, value);
}
function from_candid_ReportData_n299(_uploadFile, _downloadFile, value) {
  return from_candid_record_n300(_uploadFile, _downloadFile, value);
}
function from_candid_Result_10_n128(_uploadFile, _downloadFile, value) {
...
function from_candid_Result_12_n118(_uploadFile, _downloadFile, value) {
...
function from_candid_Result_15_n91(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n92(_uploadFile, _downloadFile, value);
}
function from_candid_Result_16_n233(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n234(_uploadFile, _downloadFile, value);
}
function from_candid_Result_17_n274(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n275(_uploadFile, _downloadFile, value);
}
function from_candid_Result_18_n76(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n77(_uploadFile, _downloadFile, value);
}
function from_candid_Result_19_n12(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n13(_uploadFile, _downloadFile, value);
}
function from_candid_Result_1_n206(_uploadFile, _downloadFile, value) {
...
function from_candid_Result_21_n10(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n11(_uploadFile, _downloadFile, value);
}
function from_candid_Result_22_n374(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n375(_uploadFile, _downloadFile, value);
}
function from_candid_Result_23_n369(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n370(_uploadFile, _downloadFile, value);
}
function from_candid_Result_24_n358(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n359(_uploadFile, _downloadFile, value);
}
function from_candid_Result_25_n316(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n317(_uploadFile, _downloadFile, value);
}
function from_candid_Result_26_n313(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n314(_uploadFile, _downloadFile, value);
}
function from_candid_Result_27_n310(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n311(_uploadFile, _downloadFile, value);
}
function from_candid_Result_28_n278(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n279(_uploadFile, _downloadFile, value);
}
function from_candid_Result_29_n292(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n293(_uploadFile, _downloadFile, value);
}
function from_candid_Result_2_n322(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n323(_uploadFile, _downloadFile, value);
}
function from_candid_Result_30_n290(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n291(_uploadFile, _downloadFile, value);
}
function from_candid_Result_31_n288(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n289(_uploadFile, _downloadFile, value);
}
function from_candid_Result_32_n271(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n272(_uploadFile, _downloadFile, value);
}
function from_candid_Result_33_n268(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n269(_uploadFile, _downloadFile, value);
}
function from_candid_Result_34_n265(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n266(_uploadFile, _downloadFile, value);
}
function from_candid_Result_35_n263(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n264(_uploadFile, _downloadFile, value);
}
function from_candid_Result_36_n226(_uploadFile, _downloadFile, value) {
...
function from_candid_Result_38_n190(_uploadFile, _downloadFile, value) {
...
function from_candid_Result_42_n161(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n162(_uploadFile, _downloadFile, value);
}
function from_candid_Result_43_n66(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n67(_uploadFile, _downloadFile, value);
}
function from_candid_Result_44_n63(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n64(_uploadFile, _downloadFile, value);
}
function from_candid_Result_45_n44(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n45(_uploadFile, _downloadFile, value);
}
function from_candid_Result_46_n37(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n38(_uploadFile, _downloadFile, value);
}
function from_candid_Result_4_n197(_uploadFile, _downloadFile, value) {
...
function from_candid_Result_6_n188(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n189(_uploadFile, _downloadFile, value);
}
function from_candid_Result_7_n176(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n177(_uploadFile, _downloadFile, value);
}
function from_candid_Result_8_n46(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n47(_uploadFile, _downloadFile, value);
}
function from_candid_Result_9_n132(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n133(_uploadFile, _downloadFile, value);
}
function from_candid_Result_n431(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n432(_uploadFile, _downloadFile, value);
}
function from_candid_Role_n110(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n111(_uploadFile, _downloadFile, value);
}
function from_candid_StandardTimeBlock_n283(_uploadFile, _downloadFile, value) {
  return from_candid_record_n284(_uploadFile, _downloadFile, value);
}
function from_candid_Standardarbeitszeiten_n280(_uploadFile, _downloadFile, value) {
  return from_candid_record_n281(_uploadFile, _downloadFile, value);
}
function from_candid_StripeEventStatus_n305(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n306(_uploadFile, _downloadFile, value);
}
function from_candid_StripeEvent_n303(_uploadFile, _downloadFile, value) {
  return from_candid_record_n304(_uploadFile, _downloadFile, value);
}
function from_candid_StripeInvoice_n308(_uploadFile, _downloadFile, value) {
  return from_candid_record_n309(_uploadFile, _downloadFile, value);
}
function from_candid_SubscriptionPlan_n215(_uploadFile, _downloadFile, value) {
  return from_candid_record_n216(_uploadFile, _downloadFile, value);
}
function from_candid_TimeBalanceCorrection_n199(_uploadFile, _downloadFile, value) {
  return from_candid_record_n200(_uploadFile, _downloadFile, value);
}
function from_candid_TimeEntryApprovalAuditEntry_n337(_uploadFile, _downloadFile, value) {
  return from_candid_record_n338(_uploadFile, _downloadFile, value);
}
function from_candid_TimeEntryStatus_n212(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n213(_uploadFile, _downloadFile, value);
}
function from_candid_TimeEntry_n33(_uploadFile, _downloadFile, value) {
  return from_candid_record_n34(_uploadFile, _downloadFile, value);
}
function from_candid_UnbilledTimeEntry_n320(_uploadFile, _downloadFile, value) {
  return from_candid_record_n321(_uploadFile, _downloadFile, value);
}
function from_candid_UserNotification_n366(_uploadFile, _downloadFile, value) {
...
function from_candid_VacationBalance_n208(_uploadFile, _downloadFile, value) {
...
function from_candid_opt_n182(_uploadFile, _downloadFile, value) {
...
function from_candid_opt_n251(_uploadFile, _downloadFile, value) {
...
function from_candid_record_n238(_uploadFile, _downloadFile, value) {
  return {
...
function from_candid_record_n258(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    aktiv: value.aktiv,
    createdAt: value.createdAt,
...
function from_candid_record_n260(_uploadFile, _downloadFile, value) {
  return {
...
function from_candid_record_n281(_uploadFile, _downloadFile, value) {
  return {
...
function from_candid_record_n300(_uploadFile, _downloadFile, value) {
  return {
...
function from_candid_record_n304(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
...
function from_candid_record_n309(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    status: value.status,
    stripeSubscriptionId: record_opt_to_undefined(from_candid_opt_n19(_uploadFile, _downloadFile, value.stripeSubscriptionId)),
...
function from_candid_record_n315(_uploadFile, _downloadFile, value) {
  return {
...
function from_candid_record_n334(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    name: value.name,
    createdAt: value.createdAt,
...
function from_candid_record_n342(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    oldStatus: value.oldStatus,
    action: value.action,
...
function from_candid_record_n351(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
...
function from_candid_record_n367(_uploadFile, _downloadFile, value) {
  return {
...
function from_candid_variant_n225(_uploadFile, _downloadFile, value) {
  return "admin" in value ? "admin" : "user" in value ? "user" : "guest" in value ? "guest" : value;
}
function from_candid_variant_n227(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
...
function from_candid_variant_n255(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n269(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
...
function from_candid_variant_n289(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
    ok: value.ok
  } : "err" in value ? {
...
function from_candid_variant_n306(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n317(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
...
function from_candid_variant_n353(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n359(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
...
function from_candid_variant_n370(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
...
function from_candid_variant_n375(_uploadFile, _downloadFile, value) {
  return "ok" in value ? {
    __kind__: "ok",
...
function from_candid_vec_n273(_uploadFile, _downloadFile, value) {
...
function from_candid_vec_n307(_uploadFile, _downloadFile, value) {
...
function from_candid_vec_n365(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_UserNotification_n366(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n368(_uploadFile, _downloadFile, value) {
...
function to_candid_AbsenceApprovalInput_n20(_uploadFile, _downloadFile, value) {
  return to_candid_record_n21(_uploadFile, _downloadFile, value);
}
function to_candid_AbsenceFilter_n329(_uploadFile, _downloadFile, value) {
  return to_candid_record_n330(_uploadFile, _downloadFile, value);
}
function to_candid_AbsenceStatus_n331(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n332(_uploadFile, _downloadFile, value);
}
function to_candid_AbsenceTypeVisibility_n72(_uploadFile, _downloadFile, value) {
  return to_candid_record_n73(_uploadFile, _downloadFile, value);
}
function to_candid_AuditEntityType_n347(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n348(_uploadFile, _downloadFile, value);
}
function to_candid_AuditLogFilter_n343(_uploadFile, _downloadFile, value) {
  return to_candid_record_n344(_uploadFile, _downloadFile, value);
}
function to_candid_AuditOperation_n345(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n346(_uploadFile, _downloadFile, value);
}
function to_candid_BillingModel_n8(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n9(_uploadFile, _downloadFile, value);
}
function to_candid_CalendarVisibilityMode_n74(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n75(_uploadFile, _downloadFile, value);
}
function to_candid_CompliancePeriodeTyp_n242(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n243(_uploadFile, _downloadFile, value);
}
function to_candid_ComplianceResolutionType_n379(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n380(_uploadFile, _downloadFile, value);
}
function to_candid_ComplianceStatus_n246(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n247(_uploadFile, _downloadFile, value);
}
function to_candid_CreateAbsenceInput_n68(_uploadFile, _downloadFile, value) {
  return to_candid_record_n69(_uploadFile, _downloadFile, value);
}
function to_candid_CreateAbsenceTypeInput_n70(_uploadFile, _downloadFile, value) {
  return to_candid_record_n71(_uploadFile, _downloadFile, value);
}
function to_candid_CreateCustomerInput_n85(_uploadFile, _downloadFile, value) {
  return to_candid_record_n86(_uploadFile, _downloadFile, value);
}
function to_candid_CreateEmployeeInput_n100(_uploadFile, _downloadFile, value) {
  return to_candid_record_n101(_uploadFile, _downloadFile, value);
}
function to_candid_CreateEmploymentInput_n114(_uploadFile, _downloadFile, value) {
  return to_candid_record_n115(_uploadFile, _downloadFile, value);
}
function to_candid_CreateExpenseInput_n124(_uploadFile, _downloadFile, value) {
  return to_candid_record_n125(_uploadFile, _downloadFile, value);
}
function to_candid_CreateExpenseTypeInput_n126(_uploadFile, _downloadFile, value) {
  return to_candid_record_n127(_uploadFile, _downloadFile, value);
}
function to_candid_CreateHolidayInput_n130(_uploadFile, _downloadFile, value) {
  return to_candid_record_n131(_uploadFile, _downloadFile, value);
}
function to_candid_CreateInvoiceInput_n134(_uploadFile, _downloadFile, value) {
  return to_candid_record_n135(_uploadFile, _downloadFile, value);
}
function to_candid_CreatePauseOverrideInput_n165(_uploadFile, _downloadFile, value) {
  return to_candid_record_n166(_uploadFile, _downloadFile, value);
}
function to_candid_CreateProjectInput_n170(_uploadFile, _downloadFile, value) {
  return to_candid_record_n171(_uploadFile, _downloadFile, value);
}
function to_candid_CreateServiceTypeInput_n186(_uploadFile, _downloadFile, value) {
  return to_candid_record_n187(_uploadFile, _downloadFile, value);
}
function to_candid_CreateTimeBalanceCorrectionInput_n194(_uploadFile, _downloadFile, value) {
  return to_candid_record_n195(_uploadFile, _downloadFile, value);
}
function to_candid_CreateTimeEntryInput_n202(_uploadFile, _downloadFile, value) {
  return to_candid_record_n203(_uploadFile, _downloadFile, value);
}
function to_candid_CreateVacationBalanceInput_n204(_uploadFile, _downloadFile, value) {
  return to_candid_record_n205(_uploadFile, _downloadFile, value);
}
function to_candid_EmploymentType_n104(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n105(_uploadFile, _downloadFile, value);
}
function to_candid_Erfassungsart_n174(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n175(_uploadFile, _downloadFile, value);
}
function to_candid_ExpenseFilter_n361(_uploadFile, _downloadFile, value) {
  return to_candid_record_n362(_uploadFile, _downloadFile, value);
}
function to_candid_ExpenseStatus_n363(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n364(_uploadFile, _downloadFile, value);
}
function to_candid_FeiertagsberechnungsartType_n116(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n117(_uploadFile, _downloadFile, value);
}
function to_candid_InvoicePositionInput_n137(_uploadFile, _downloadFile, value) {
  return to_candid_record_n138(_uploadFile, _downloadFile, value);
}
function to_candid_InvoicePositionTyp_n139(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n140(_uploadFile, _downloadFile, value);
}
function to_candid_InvoiceStatus_n415(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n416(_uploadFile, _downloadFile, value);
}
function to_candid_InvoiceTemplateInput_n159(_uploadFile, _downloadFile, value) {
  return to_candid_record_n160(_uploadFile, _downloadFile, value);
}
function to_candid_KundeZeiterfassungsart_n89(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n90(_uploadFile, _downloadFile, value);
}
function to_candid_NotificationFormat_n141(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n142(_uploadFile, _downloadFile, value);
}
function to_candid_NotificationPriority_n143(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n144(_uploadFile, _downloadFile, value);
}
function to_candid_NotificationTargetType_n146(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n147(_uploadFile, _downloadFile, value);
}
function to_candid_PaymentProvider_n429(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n430(_uploadFile, _downloadFile, value);
}
function to_candid_ProjectMemberAssignment_n388(_uploadFile, _downloadFile, value) {
  return to_candid_record_n389(_uploadFile, _downloadFile, value);
}
function to_candid_ProjectStatus_n172(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n173(_uploadFile, _downloadFile, value);
}
function to_candid_Rechnungsadresse_n87(_uploadFile, _downloadFile, value) {
  return to_candid_record_n88(_uploadFile, _downloadFile, value);
}
function to_candid_ReportFilter_n297(_uploadFile, _downloadFile, value) {
  return to_candid_record_n298(_uploadFile, _downloadFile, value);
}
function to_candid_ResolveFindingInput_n377(_uploadFile, _downloadFile, value) {
...
function to_candid_StandardTimeBlock_n385(_uploadFile, _downloadFile, value) {
  return to_candid_record_n386(_uploadFile, _downloadFile, value);
}
function to_candid_Standardarbeitszeiten_n382(_uploadFile, _downloadFile, value) {
  return to_candid_record_n383(_uploadFile, _downloadFile, value);
}
function to_candid_SubscriptionPlan_n427(_uploadFile, _downloadFile, value) {
  return to_candid_record_n428(_uploadFile, _downloadFile, value);
}
function to_candid_TimeEntryApprovalInput_n30(_uploadFile, _downloadFile, value) {
  return to_candid_record_n21(_uploadFile, _downloadFile, value);
}
function to_candid_TimeEntryFilter_n372(_uploadFile, _downloadFile, value) {
  return to_candid_record_n373(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateAbsenceInput_n390(_uploadFile, _downloadFile, value) {
  return to_candid_record_n391(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateAbsenceTypeInput_n392(_uploadFile, _downloadFile, value) {
  return to_candid_record_n393(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateCompanyInput_n394(_uploadFile, _downloadFile, value) {
  return to_candid_record_n395(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateComplianceProfileInput_n396(_uploadFile, _downloadFile, value) {
  return to_candid_record_n397(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateCustomerInput_n399(_uploadFile, _downloadFile, value) {
  return to_candid_record_n400(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateEmployeeInput_n403(_uploadFile, _downloadFile, value) {
  return to_candid_record_n404(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateEmploymentInput_n405(_uploadFile, _downloadFile, value) {
  return to_candid_record_n406(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateExpenseInput_n407(_uploadFile, _downloadFile, value) {
  return to_candid_record_n408(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateExpenseTypeInput_n409(_uploadFile, _downloadFile, value) {
  return to_candid_record_n410(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateHolidayInput_n411(_uploadFile, _downloadFile, value) {
  return to_candid_record_n412(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateInvoiceInput_n413(_uploadFile, _downloadFile, value) {
  return to_candid_record_n414(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateProjectInput_n417(_uploadFile, _downloadFile, value) {
  return to_candid_record_n418(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateServiceTypeInput_n419(_uploadFile, _downloadFile, value) {
  return to_candid_record_n420(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateTimeBalanceCorrectionInput_n421(_uploadFile, _downloadFile, value) {
  return to_candid_record_n422(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateTimeEntryInput_n423(_uploadFile, _downloadFile, value) {
  return to_candid_record_n424(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateVacationBalanceInput_n425(_uploadFile, _downloadFile, value) {
...
function to_candid_opt_n241(_uploadFile, _downloadFile, value) {
  return value === null ? candid_none() : candid_some(to_candid_CompliancePeriodeTyp_n242(_uploadFile, _downloadFile, value));
}
function to_candid_opt_n244(_uploadFile, _downloadFile, value) {
  return value === null ? candid_none() : candid_some(to_candid_vec_n245(_uploadFile, _downloadFile, value));
}
function to_candid_opt_n301(_uploadFile, _downloadFile, value) {
  return value === null ? candid_none() : candid_some(value);
}
function to_candid_opt_n339(_uploadFile, _downloadFile, value) {
  return value === null ? candid_none() : candid_some(value);
}
...
function to_candid_record_n166(_uploadFile, _downloadFile, value) {
  return {
    action: value.action,
    userId: value.userId,
    date: value.date,
...
function to_candid_record_n187(_uploadFile, _downloadFile, value) {
  return {
...
function to_candid_record_n195(_uploadFile, _downloadFile, value) {
  return {
...
function to_candid_record_n203(_uploadFile, _downloadFile, value) {
  return {
    bis: value.bis ? candid_some(value.bis) : candid_none(),
...
function to_candid_record_n205(_uploadFile, _downloadFile, value) {
  return {
...
function to_candid_record_n298(_uploadFile, _downloadFile, value) {
  return {
    dateTo: value.dateTo,
...
function to_candid_record_n330(_uploadFile, _downloadFile, value) {
  return {
...
function to_candid_record_n344(_uploadFile, _downloadFile, value) {
  return {
    dateTo: value.dateTo ? candid_some(value.dateTo) : candid_none(),
...
function to_candid_record_n373(_uploadFile, _downloadFile, value) {
  return {
    dateTo: value.dateTo ? candid_some(value.dateTo) : candid_none(),
    employeeId: value.employeeId ? candid_some(value.employeeId) : candid_none(),
    projectId: value.projectId ? candid_some(value.projectId) : candid_none(),
...
function to_candid_record_n378(_uploadFile, _downloadFile, value) {
  return {
...
function to_candid_record_n383(_uploadFile, _downloadFile, value) {
  return {
...
function to_candid_record_n386(_uploadFile, _downloadFile, value) {
  return {
    bis: value.bis,
    von: value.von,
...
function to_candid_record_n389(_uploadFile, _downloadFile, value) {
  return {
    stundensatz: value.stundensatz,
    employeeId: value.employeeId,
    kostendachCHF: value.kostendachCHF ? candid_some(value.kostendachCHF) : candid_none(),
...
function to_candid_record_n391(_uploadFile, _downloadFile, value) {
  return {
    dateTo: value.dateTo ? candid_some(value.dateTo) : candid_none(),
...
function to_candid_record_n393(_uploadFile, _downloadFile, value) {
  return {
    aktiv: value.aktiv ? candid_some(value.aktiv) : candid_none(),
...
function to_candid_record_n395(_uploadFile, _downloadFile, value) {
  return {
...
function to_candid_record_n397(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    aktiv: value.aktiv,
...
function to_candid_record_n400(_uploadFile, _downloadFile, value) {
  return {
...
function to_candid_record_n404(_uploadFile, _downloadFile, value) {
  return {
    ort: value.ort ? candid_some(value.ort) : candid_none(),
    plz: value.plz ? candid_some(value.plz) : candid_none(),
...
function to_candid_record_n408(_uploadFile, _downloadFile, value) {
  return {
...
function to_candid_record_n410(_uploadFile, _downloadFile, value) {
  return {
    aktiv: value.aktiv ? candid_some(value.aktiv) : candid_none(),
    name: value.name ? candid_some(value.name) : candid_none(),
...
function to_candid_record_n428(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    features: value.features,
    requiresPayment: value.requiresPayment,
...
function to_candid_record_n86(_uploadFile, _downloadFile, value) {
  return {
    rechnungsadresse: value.rechnungsadresse ? candid_some(to_candid_Rechnungsadresse_n87(_uploadFile, _downloadFile, value.rechnungsadresse)) : candid_none(),
    contact: value.contact ? candid_some(value.contact) : candid_none(),
    aktiv: value.aktiv ? candid_some(value.aktiv) : candid_none(),
...
function to_candid_variant_n196(_uploadFile, _downloadFile, value) {
...
function to_candid_variant_n243(_uploadFile, _downloadFile, value) {
  return value == "DAY" ? {
    DAY: null
  } : value == "SERVICE_YEAR" ? {
    SERVICE_YEAR: null
...
function to_candid_variant_n247(_uploadFile, _downloadFile, value) {
...
function to_candid_variant_n332(_uploadFile, _downloadFile, value) {
...
function to_candid_variant_n346(_uploadFile, _downloadFile, value) {
  return value == "reject" ? {
    reject: null
  } : value == "remove" ? {
    remove: null
...
function to_candid_variant_n348(_uploadFile, _downloadFile, value) {
...
function to_candid_variant_n364(_uploadFile, _downloadFile, value) {
...
function to_candid_variant_n380(_uploadFile, _downloadFile, value) {
...
function to_candid_variant_n416(_uploadFile, _downloadFile, value) {
...
function to_candid_variant_n430(_uploadFile, _downloadFile, value) {
  return value == "stripe" ? {
    stripe: null
  } : value == "none" ? {
    none: null
...
function to_candid_vec_n245(_uploadFile, _downloadFile, value) {
  return value.map((x) => to_candid_ComplianceStatus_n246(_uploadFile, _downloadFile, x));
}
function to_candid_vec_n384(_uploadFile, _downloadFile, value) {
  return value.map((x) => to_candid_StandardTimeBlock_n385(_uploadFile, _downloadFile, x));
}
function to_candid_vec_n387(_uploadFile, _downloadFile, value) {
