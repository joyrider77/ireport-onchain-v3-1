import { r as reactExports, j as jsxRuntimeExports, a as useNavigate, e as useQueryClient, S as Skeleton } from "./index-CzAnGejr.js";
import { D as DeleteConfirmDialog, P as Pencil, T as Trash2 } from "./DeleteConfirmDialog-BE0ulj3u.js";
import { u as useCompanyTimezone, t as toDateStringInTz, L as Layout, T as TimeEntryDialog, e as formatHours, m as minutesToHHMM, X, D as Dialog, g as DialogContent, h as DialogHeader, i as DialogTitle, j as Checkbox, n as normalizeTimeInput, k as DialogFooter, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, l as hhmmToMinutes, o as isValidHHMM } from "./Layout-B1HD-_-K.js";
...
import { g as getActiveEmploymentForDate, a as getEmploymentMinutesForDate, b as getMostRecentEmploymentBefore } from "./employmentUtils-C-5ZbofZ.js";
import { a as useActor, b as useQuery, c as createActor } from "./backend-BNIvB4__.js";
import { j as ChevronLeft, h as ChevronRight, k as Clock, R as Receipt } from "./users-BqWALrTR.js";
...
function isVacationType(absenceTypeId, types) {
  ...
  return (t == null ? void 0 : t.requiresApproval) ?? false;
}
...
function AbwesenheitFormDialog({
  ...
  const nonVacationTypes = absenceTypes.filter(
    (t) => t.id !== (vacationType == null ? void 0 : vacationType.id)
  );
  const [form, setForm] = reactExports.useState({
    absenceTypeId: "",
    dateFrom: initialDate,
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity ml-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 sm:p-6 space-y-4", "data-ocid": "kalender-page", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl shadow-card overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 border-b border-border bg-muted/30", children: GERMAN_DAYS.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 gap-px bg-border p-0", children: Array.from({ length: 35 }, (_, i) => `skel-${i}`).map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Skeleton,
          {
            className: "h-[90px] rounded-none bg-muted/40"
          },
          key
        )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 gap-px bg-border p-0", children: gridDates.map((d, i) => {
